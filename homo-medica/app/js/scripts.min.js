...
!(function (e, t) {
  ...
  var C = (function (e) {
    ...
    try {
      j.apply((D = M.call(b.childNodes)), b.childNodes),
    ...
    function ae(e, t, i, o) {
      ...
      if (!o && (p(t), (t = t || f), m)) {
        ...
        if (
          ...
          if (((g = e), (y = t), 1 === b && (U.test(e) || F.test(e)))) {
            for (
      ...
      return (
        ...
        ce(function (r, s, a, l) {
          var c,
            ...
            v = !e || (!r && t) ? m : Se(m, p, e, a, l),
            g = n ? (o || (r ? e : h || i) ? [] : s) : v;
          if ((n && n(v, g, a, l), i))
            for (c = Se(g, f), i(c, [], a, l), d = c.length; d--; )
              (u = c[d]) && (g[f[d]] = !(v[f[d]] = u));
          if (r) {
            if (o || e) {
              if (o) {
          ...
          } else (g = Se(g === s ? g.splice(h, g.length) : g)), o ? o(null, s, g, l) : j.apply(s, g);
        })
      );
    }
    function Te(e) {
          ...
          (v = _(
            ...
            (d = function (e, t, n, s, d) {
              ...
              for (
                ...
                if (l && u) {
                  for (
                    h = 0, t || u.ownerDocument == f || (p(u), (n = !m));
                    (v = o[h++]);
                ...
                a && ((u = !v && u) && g--, e && w.push(u));
              }
              if (((g += y), a && y !== g)) {
                for (h = 0; (v = r[h++]); ) v(w, x, t, n);
                if (e) {
                  if (0 < g) for (; y--; ) w[y] || x[y] || (x[y] = O.call(s));
                  x = Se(x);
                }
                j.apply(s, x),
                  d &&
  ...
  (b.filter = function (e, t, n) {
    ...
    b.fn.extend({
      ...
      is: function (e) {
        return !!E(this, "string" == typeof e && _.test(e) ? b(e) : e || [], !1)
          .length;
      },
    });
  var D,
    ...
    if (((n = n || D), "string" == typeof e)) {
      ...
      if (i[1]) {
        if (
          ...
          b.merge(
            this,
            b.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : v, !0)
          ),
      ...
      function (e, t) {
        b.fn[e] = function (n, i) {
          ...
          return (
            ...
            1 < this.length &&
              (j[e] || b.uniqueSort(o), L.test(e) && o.reverse()),
            this.pushStack(o)
          );
        };
      }
        ...
        var n = [
          ...
          o = {
            ...
            then: function (t, i, o) {
              ...
              return b
                .Deferred(function (e) {
                  n[0][3].add(s(0, e, h(o) ? o : H, e.notifyWith)),
  ...
  var se = function (e, t) {
    return (
      ...
      ("" === e.style.display && oe(e) && "none" === b.css(e, "display"))
    );
  };
  function ae(e, t, n, i) {
    var o,
            ...
            "" === i.style.display &&
              ...
              (c[d] =
                ...
                (l = le[a]) ||
                  ...
                  "none" === l && (l = "block"),
                  (le[a] = l)))))
          : "none" !== n && ((c[d] = "none"), G.set(i, "display", n)));
  ...
  function we(e, t, n, i, o) {
    ...
    for (u.textContent = "", f = 0; (r = p[f++]); )
      if (i && -1 < b.inArray(r, i)) o && o.push(r);
        ...
        ((c = oe(r)), (s = ve(u.appendChild(r), "script")), c && ge(s), n)
      )
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            pe.test(t.type) && t.click && $(t, "input") && $e(t, "click", Ce),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            pe.test(t.type) && t.click && $(t, "input") && $e(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  function Me(e, t) {
    ...
    if (1 === t.nodeType) {
      ...
      Q.hasData(e) && ((r = Q.access(e)), (s = b.extend({}, r)), Q.set(t, s));
    }
  }
  function Be(e, t, n, i) {
    t = r(t);
    var o,
      ...
      v = t[0],
      g = h(v);
    if (g || (1 < p && "string" == typeof v && !f.checkClone && Ee.test(v)))
      return e.each(function (o) {
        var r = e.eq(o);
        g && (t[0] = v.call(this, o, r.html())), Be(r, t, n, i);
      });
    if (
      p &&
      ...
      for (l = (a = b.map(ve(o, "script"), Le)).length; u < p; u++)
        (c = o),
          u !== m &&
            ((c = b.clone(c, !0, !0)), l && b.merge(a, ve(c, "script"))),
          n.call(e[u], c, u);
      if (l)
        for (d = a[a.length - 1].ownerDocument, b.map(a, je), u = 0; u < l; u++)
          (c = a[u]),
            he.test(c.type || "") &&
  ...
  function He(e, t, n) {
    for (var i, o = t ? b.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
      n || 1 !== i.nodeType || b.cleanData(ve(i)),
        i.parentNode &&
          (n && oe(i) && ge(ve(i, "script")), i.parentNode.removeChild(i));
    return e;
  }
  b.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (t)
        if (n)
          for (r = r || ve(e), s = s || ve(d), i = 0, o = r.length; i < o; i++)
            Me(r[i], s[i]);
        else Me(e, d);
      return (
        0 < (s = ve(d, "script")).length && ge(s, !u && ve(e, "script")), d
      );
    },
  ...
  (b.Animation = b.extend(ut, {
        ...
        if ((l = !b.isEmptyObject(t)) || !b.isEmptyObject(f))
          ...
          f))
            l ||
              ...
              m && ce([e], !0),
              p.done(function () {
                for (i in (m || ce([e]), G.remove(e, "fxshow"), f))
                  b.style(e, i, f[i]);
              })),
              (l = dt(m ? v[i] : 0, i, p)),
              i in v ||
    ...
    (ot = v.createElement("select").appendChild(v.createElement("option"))),
    (it.type = "checkbox"),
    (f.checkOn = "" !== it.value),
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              ...
              ((i = o[s]).selected =
                -1 < b.inArray(b.valHooks.option.get(i), r)) && (n = !0);
    ...
    trigger: function (t, n, i, o) {
      ...
      if (
        ...
        3 !== i.nodeType &&
          ...
          (-1 < y.indexOf(".") && ((y = (w = y.split(".")).shift()), w.sort()),
          (c = y.indexOf(":") < 0 && "on" + y),
          ((t = t[b.expando]
            ? t
        ...
        if (!o && !p.noBubble && !m(i)) {
          for (
            l = p.delegateType || y, xt.test(l + y) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            g.push(s), (a = s);
    ...
    b.extend({
      ...
      ajax: function (t, n) {
        ...
        var i,
          ...
          f = b.ajaxSetup({}, n),
          h = f.context || f,
          m = f.context && (h.nodeType || h.jquery) ? b(h) : b.event,
          g = b.Deferred(),
            ...
            u
              ? (f.ifModified &&
                  ((S = T.getResponseHeader("Last-Modified")) &&
                    (b.lastModified[o] = S),
                  (S = T.getResponseHeader("etag")) && (b.etag[o] = S)),
                204 === t || "HEAD" === f.type
                  ? (C = "nocontent")
                  : 304 === t
                  ? (C = "notmodified")
                  : ((C = x.state), (p = x.data), (u = !(v = x.error))))
              : ((v = C), (!t && C) || ((C = "error"), t < 0 && (t = 0))),
            (T.status = t),
            (T.statusText = (n || C) + ""),
            u ? g.resolveWith(h, [p, C, T]) : g.rejectWith(h, [T, C, v]),
            T.statusCode(w),
            (w = void 0),
            d && m.trigger(u ? "ajaxSuccess" : "ajaxError", [T, f, u ? p : v]),
            y.fireWith(h, [T, C]),
            d &&
  ...
  b.ajaxSetup({
    ...
    jsonpCallback: function () {
      var e = Xt.pop() || b.expando + "_" + Ct.guid++;
      return (this[e] = !0), e;
    },
  }),
    ...
    (b.parseHTML = function (e, t, n) {
      return "string" != typeof e
        ...
        : ("boolean" == typeof t && ((n = t), (t = !1)),
          t ||
            (f.createHTMLDocument
              ? (((i = (t = v.implementation.createHTMLDocument(
                  ""
    ...
    b.each(["top", "left"], function (e, t) {
      b.cssHooks[t] = We(f.pixelPosition, function (e, n) {
        if (n)
          return (n = Re(e, t)), Pe.test(n) ? b(e).position()[t] + "px" : n;
      });
    }),
  ...
  return (
    (b.noConflict = function (t) {
      return e.$ === b && (e.$ = Qt), t && e.jQuery === b && (e.jQuery = Gt), b;
    }),
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const e = document.querySelector(".header"),
      ...
      i = document.querySelector(".socials__form"),
      o = document.querySelector(".hamburger"),
      r = document.querySelector(".header__mobile_menu"),
      s = document.querySelectorAll(".mobile__menu_link"),
      a = document.querySelector(".mobile__menu_close"),
      l = document.querySelector(".poppup__form_overlay"),
      c = document.querySelector(".poppup__form_container"),
      d = document.querySelector(".header__btn"),
      u = document.querySelector(".mobile__btn"),
      p = document.querySelector(".form__btn"),
      f = document.querySelector(".poppup__form"),
      h = document.querySelector(".form__succes");
    function m() {
      (h.style.opacity = 0), (h.style.visibility = "hidden"), g();
    }
    function v() {
      (l.style.opacity = "1"),
    ...
    setTimeout(function () {
      ...
      a.addEventListener("click", () => {
        w(), o.classList.remove("is-active");
      }),
      n.forEach((e) => {
        e.style.top = t - 20 + "px";
      }),
      s.forEach((e) => {
        e.addEventListener("click", () => {
          o.classList.remove("is-active"), w();
        });
      }),
      null != i &&
        null != i &&
  ...
  (function (e) {
    (e.nSelect = function (t, n) {
      function i(t, n) {
        return void 0 === n
          ? void e(".nselect").removeClass("_active")
          : (n.removeClass("_active"), void e(window).trigger("niceClose"));
      }
      function o(e, n) {
        t.val(e), n.data("val", e);
      }
      function r(t, n) {
        var i = e(n),
          r = i.find("span").html(),
          s = i.data("val");
        i.addClass("_active").siblings("li").removeClass("_active"),
          1 == a.hideAfterSelect &&
            i.addClass("_hide").siblings("li").removeClass("_hide"),
          t.addClass("_checked"),
          e(".nselect__head", t).attr("title", r),
          e(".nselect__head SPAN", t).html(r),
          o(s, t),
      ...
      return (
        (function () {
          var n = (function (t) {
              ...
              return (
                t.hide(),
                a.topList && (r.top = "_top"),
                (t.hasClass("_disabled") || a.disabled) &&
                ...
                (s = t
                  ...
                  .prepend(
                    '<div class="nselect__inner"><ul class="nselect__list"></ul></div>'
                  )),
                (l = { selectList: e(".nselect__list", s), selectItem: {} }),
                t.find("option").each(function () {
                  ...
                  i.attr("selected")
                    ...
                    (t =
                      ...
                      r +
                      "</span></li>"),
                    l.selectList.append(t);
                }),
                (l.selectItem = e(".nselect__inner li", s)),
                void 0 === n &&
                  ((c = !0),
                  (n = t.find("option")),
                  l.selectItem.eq(0).addClass("_active"),
                  1 == a.hideAfterSelect &&
                    l.selectItem.eq(0).addClass("_hide")),
                (i = n.html()),
                (o = n.val()),
                "" !== a.firstTitle &&
                  c &&
                  (l.selectItem.removeClass("_active"),
                  t.val(""),
                  (i = a.firstTitle),
                  (o = "")),
                "" !== d &&
                  ...
                  (o = "")),
                s.prepend(
                  '<h6 class="nselect__head" data-val="' +
                    o +
                    '"><span>' +
                    i +
                    "</span></h6>"
                ),
                e(".nselect__head", s).attr(
                  "title",
                  e(".nselect__head SPAN", s).html()
                ),
                s
              );
            })(t),
            o = {
              selectBtn: e(".nselect__head", n),
              selectHeadInner: e(".nselect__head SPAN", n),
              selectList: e(".nselect__list", n),
              selectItem: e(".nselect__inner li", n),
            };
          o.selectBtn.on("click", function () {
            var t = e(this);
            n.hasClass("_active")
              ? i(t, n)
              : (function (t, n) {
                  n.addClass("_active"),
                    a.afterOpen(t),
                    e(window).trigger("nOpen");
                })(t, n),
              !s &&
                jQuery.mCustomScrollbar &&
                (function (e) {
                  e.mCustomScrollbar("destroy"),
                    e.mCustomScrollbar({ theme: a.scrollbarTheme }),
                    (s = !0);
                })(o.selectList);
          }),
            o.selectItem.on("click", function () {
              var t = e(this);
              r(n, t), a.afterChange(t), i(t);
            });
        })(),
        this
      );
  ...
  (function (e) {
    ...
    var t,
      ...
      te,
      ne;
    (ee = "function" == typeof define && define.amd),
      (te = "undefined" != typeof module && module.exports),
      ...
      (c = {
        init: function (t) {
          ...
          var n = d.call(this);
          if (t.live) {
            var s = t.liveSelector || this.selector || ".mCustomScrollbar",
              a = e(s);
            if ("off" === t.live) return void p(s);
            r[s] = setTimeout(function () {
              a.mCustomScrollbar(t), "once" === t.live && a.length && p(s);
            }, 500);
          } else p(s);
          return (
            ...
            e(n).each(function () {
              ...
              if (!n.data("mCS")) {
                ...
                var i = n.data("mCS"),
                  ...
                  d = n.data("mcs-theme");
                s && (r.axis = s),
                  a && (r.scrollbarPosition = a),
                  d && ((r.theme = d), u(r)),
                  m.call(this),
                  e(
                    "#mCSB_" + i.idx + "_container img:not(." + l[2] + ")"
                  ).addClass(l[2]),
          ...
          return e(i).each(function () {
            ...
            if (t.data("mCS")) {
              var i = t.data("mCS"),
                ...
                s = [
                  e("#mCSB_" + i.idx + "_dragger_vertical"),
                  e("#mCSB_" + i.idx + "_dragger_horizontal"),
                ];
              if (!r.length) return;
              i.tweenRunning && F(t),
                ...
                "y" === o.axis ||
                  ...
                  r.css("width", v(r.children())),
                (i.overflowed = C.call(this)),
                $.call(this),
                o.autoDraggerLength && x.call(this),
                b.call(this),
                k.call(this);
              var a = [Math.abs(r[0].offsetTop), Math.abs(r[0].offsetLeft)];
              "x" !== o.axis &&
                (i.overflowed[0]
            ...
            return e(i).each(function () {
              ...
              if (i.data("mCS")) {
                var o = i.data("mCS"),
                  ...
                  l = R.call(this, t),
                  c =
                    a.scrollInertia > 0 && a.scrollInertia < 17
                      ? 17
                      : a.scrollInertia;
                (l[0] = W.call(this, l[0], "y")),
                  (l[1] = W.call(this, l[1], "x")),
                  a.moveDragger &&
                    ((l[0] *= o.scrollRatio.y), (l[1] *= o.scrollRatio.x)),
                  (a.dur = c),
                  setTimeout(function () {
                    null !== l[0] &&
                      void 0 !== l[0] &&
        ...
        var t = e(this),
          ...
          d =
            "yx" === o.axis
              ...
              : "",
          u = o.autoHideScrollbar ? " " + l[6] : "",
          p = "x" !== o.axis && "rtl" === i.langDir ? " " + l[7] : "";
        o.setWidth && t.css("width", o.setWidth),
          o.setHeight && t.css("height", o.setHeight),
          (o.setLeft =
            "y" !== o.axis && "rtl" === i.langDir ? "989999px" : o.setLeft),
          t
            .addClass(n + " _mCS_" + i.idx + u + p)
            .wrapInner(
              "<div id='mCSB_" +
                i.idx +
      ...
      (y = function () {
        var t = e(this).data("mCS"),
          n = t.opt,
          i = e(".mCSB_" + t.idx + "_scrollbar:first"),
          o = K(n.scrollButtons.tabindex)
      ...
      (w = function () {
        var t = e(this),
          ...
          s = t.css("box-sizing");
        if ("none" !== o) {
          var a = r ? (t.parent().height() * parseInt(o)) / 100 : parseInt(o);
          "border-box" === s &&
            (a -=
              t.innerHeight() -
              t.height() +
              (t.outerHeight() - t.innerHeight())),
            i.css("max-height", Math.round(a));
        }
      }),
      (x = function () {
        var t = e(this).data("mCS"),
      ...
      (S = function (e, t, n) {
        ...
        "active" === t
          ...
          : e[0]._draggable ||
            ("hide" === t
              ? (e.removeClass(l[0]), o.removeClass(l[1]))
              : (e.addClass(l[0]), o.addClass(l[1])));
      }),
      (C = function () {
        var t = e(this).data("mCS"),
          n = e("#mCSB_" + t.idx),
          i = e("#mCSB_" + t.idx + "_container"),
          o = null == t.overflowed ? i.height() : i.outerHeight(!1),
          r = null == t.overflowed ? i.width() : i.outerWidth(!1);
        return [o > n.height(), r > n.width()];
      }),
      (T = function () {
        var t = e(this),
          n = t.data("mCS"),
        ...
        if (
          ...
          (("x" !== i.axis && !n.overflowed[0]) ||
            ...
            (s[0].add(r).css("top", 0), U(t, "_resetY")),
          ("y" !== i.axis && !n.overflowed[1]) ||
            ("x" === i.axis && n.overflowed[1]))
        ) {
          var a = (dx = 0);
          "rtl" === n.langDir &&
            ((a = o.width() - r.outerWidth(!1)),
            (dx = Math.abs(a / n.scrollRatio.x))),
            r.css("left", a),
            s[1].css("left", dx),
            U(t, "_resetX");
        }
      ...
      (k = function () {
        ...
        i.bindEvents ||
          ...
          o.scrollButtons.enable && q.call(this),
          o.keyboard.enable && N.call(this),
          (i.bindEvents = !0));
      }),
      (_ = function () {
        var t = e(this),
      ...
      ($ = function (t) {
        var n = e(this),
          ...
          a = [
            e("#mCSB_" + i.idx + "_scrollbar_vertical"),
            e("#mCSB_" + i.idx + "_scrollbar_horizontal"),
          ],
          c = [a[0].find(".mCSB_dragger"), a[1].find(".mCSB_dragger")];
        "x" !== o.axis &&
          (i.overflowed[0] && !t
            ? (a[0].add(c[0]).add(a[0].children("a")).css("display", "block"),
              s.removeClass(l[8] + " " + l[10]))
            : (o.alwaysShowScrollbar
                ? (2 !== o.alwaysShowScrollbar && c[0].css("display", "none"),
                  s.removeClass(l[10]))
                : (a[0].css("display", "none"), s.addClass(l[10])),
              s.addClass(l[8]))),
          "y" !== o.axis &&
            (i.overflowed[1] && !t
              ? (a[1].add(c[1]).add(a[1].children("a")).css("display", "block"),
                s.removeClass(l[9] + " " + l[11]))
              : (o.alwaysShowScrollbar
                  ? (2 !== o.alwaysShowScrollbar && c[1].css("display", "none"),
                    s.removeClass(l[11]))
                  : (a[1].css("display", "none"), s.addClass(l[11])),
                s.addClass(l[9]))),
      ...
      (E = function () {
        var t,
          ...
          p = e("#" + d[0] + ",#" + d[1]),
          f = l.advanced.releaseDraggableSelectors
            ? p.add(e(l.advanced.releaseDraggableSelectors))
            : p;
        function h(e) {
          var t = u.find("iframe");
          if (t.length) {
        ...
        function m(e, n, i, s) {
          if (
            ((u[0].idleTimer = l.scrollInertia < 233 ? 250 : 0),
            t.attr("id") === d[1])
          )
            var a = "x",
              c = (t[0].offsetLeft - n + s) * r.scrollRatio.x;
          else (a = "y"), (c = (t[0].offsetTop - e + i) * r.scrollRatio.y);
          U(o, c.toString(), { dir: a, drag: !0 });
        }
        p
          .bind(
            "mousedown." +
              ...
              c,
            function (r) {
              if ((r.stopImmediatePropagation(), r.preventDefault(), Q(r))) {
                (a = !0),
                  s &&
                ...
                var c = (t = e(this)).offset(),
                  ...
                  p = t.height() + c.top,
                  f = t.width() + c.left;
                d < p && d > 0 && u < f && u > 0 && ((n = d), (i = u)),
                  S(t, "active", l.autoExpandScrollbar);
              }
            }
          )
          ...
          e(document)
            .bind(
              "mousemove." + c + " pointermove." + c + " MSPointerMove." + c,
              function (e) {
                if (t) {
                  var o = t.offset(),
                    r = A(e)[0] - o.top,
            ...
            .bind(
              "mouseup." +
                ...
                c,
              function (e) {
                t && (S(t, "active", l.autoExpandScrollbar), (t = null)),
                  (a = !1),
      ...
      (D = function () {
        var n,
          ...
          w = "mCS_" + g.idx,
          x = e("#mCSB_" + g.idx),
          b = e("#mCSB_" + g.idx + "_container"),
          S = [
            e("#mCSB_" + g.idx + "_dragger_vertical"),
            e("#mCSB_" + g.idx + "_dragger_horizontal"),
          ],
          C = [],
          T = [],
          k = "yx" === y.axis ? "none" : "all",
          _ = [],
          $ = b.find("iframe"),
          E = [
        ...
        function O(e) {
          if (
            ...
            !a &&
            !A(e)[2] &&
            (e.stopImmediatePropagation(), !m || h)
          ) {
            l = Y();
            var t = x.offset(),
              o = A(e)[0] - t.top,
            ...
            if (
              (C.push(o),
              T.push(r),
              (_[2] = Math.abs(A(e)[0] - _[0])),
              (_[3] = Math.abs(A(e)[1] - _[1])),
              g.overflowed[0])
            )
              var s = S[0].parent().height() - S[0].height(),
                c =
                  n - o > 0 &&
                  o - n > -s * g.scrollRatio.y &&
                  (2 * _[3] < _[2] || "yx" === y.axis);
            if (g.overflowed[1])
              var d = S[1].parent().width() - S[1].width(),
                u =
                  i - r > 0 &&
                  r - i > -d * g.scrollRatio.x &&
                  (2 * _[2] < _[3] || "yx" === y.axis);
            c || u ? (e.preventDefault(), (h = 1)) : (m = 1),
              (p =
                "yx" === y.axis
                  ? [n - o, i - r]
                  : "x" === y.axis
                  ...
                  : [n - o, null]),
              (b[0].idleTimer = 250),
              g.overflowed[0] && H(p[0], 0, "mcsLinearOut", "y", "all", !0),
              g.overflowed[1] && H(p[1], 0, "mcsLinearOut", "x", k, !0);
          }
        }
        function L(e) {
          if (!J(e) || a || A(e)[2]) t = 0;
          else {
            (t = 1), e.stopImmediatePropagation(), F(v), (s = Y());
            var n = x.offset();
            (o = A(e)[0] - n.top), (r = A(e)[1] - n.left), (C = []), (T = []);
          }
        }
        function M(e) {
          if (J(e) && !a && !A(e)[2]) {
            e.stopImmediatePropagation(), (h = 0), (m = 0), (c = Y());
            var t = x.offset(),
              n = A(e)[0] - t.top,
              i = A(e)[1] - t.left;
            if (!(c - l > 30)) {
              var v = (u = 1e3 / (c - s)) < 2.5,
                w = v ? [C[C.length - 2], T[T.length - 2]] : [0, 0];
              d = v ? [n - w[0], i - w[1]] : [n - o, i - r];
              var S = [Math.abs(d[0]), Math.abs(d[1])];
              u = v ? [Math.abs(d[0] / 4), Math.abs(d[1] / 4)] : [u, u];
              var _ = [
                Math.abs(b[0].offsetTop) - d[0] * B(S[0] / u[0], u[0]),
                Math.abs(b[0].offsetLeft) - d[1] * B(S[1] / u[1], u[1]),
              ];
              (p =
                "yx" === y.axis
                  ? [_[0], _[1]]
                  ...
                  ? [null, _[1]]
                  : [_[0], null]),
                (f = [4 * S[0] + y.scrollInertia, 4 * S[1] + y.scrollInertia]);
              var $ = parseInt(y.contentTouchScroll) || 0;
              (p[0] = S[0] > $ ? p[0] : 0),
                (p[1] = S[1] > $ ? p[1] : 0),
                g.overflowed[0] && H(p[0], f[0], "mcsEaseOut", "y", k, !1),
                g.overflowed[1] && H(p[1], f[1], "mcsEaseOut", "x", k, !1);
            }
          }
        }
        function B(e, t) {
      ...
      (O = function () {
        ...
        function u(e, t, o) {
          (s.type = o && n ? "stepped" : "stepless"),
            (s.scrollAmount = 10),
            I(i, e, t, "mcsLinearOut", o ? 60 : null);
        }
        c.bind("mousedown." + l, function (e) {
          ...
          .bind("mousemove." + l, function (e) {
            if (
              ...
              var i = c.offset(),
                a = A(e)[0] - i.top + c[0].offsetTop,
                l = A(e)[1] - i.left + c[0].offsetLeft;
              a > 0 && a < d.height() && l > 0 && l < d.width()
                ? s.step && u("off", null, "stepped")
                : ("x" !== r.axis &&
                    o.overflowed[0] &&
                    (a < 0 ? u("on", 38) : a > d.height() && u("on", 40)),
                  "y" !== r.axis &&
                    o.overflowed[1] &&
                    (l < 0 ? u("on", 37) : l > d.width() && u("on", 39)));
            }
          })
          .bind("mouseup." + l, function (e) {
            t || (n && ((n = 0), u("off", null)), (a = !1));
          });
      }),
      (L = function () {
        var t = e(this),
          ...
          if ((F(t), !M(t, o.target))) {
            ...
            if ("x" === i.axis || "x" === i.mouseWheel.axis)
              var d = "x",
                ...
                h = a[1][0].offsetLeft,
                m = a[1].parent().width() - a[1].width(),
                v = o.deltaX || o.deltaY || l;
            else
              (d = "y"),
                (u = [
      ...
      (M = function (t, n) {
        ...
        return (
          e.inArray(i, o) > -1 &&
          !(e.inArray(i, ["select", "textarea"]) > -1 && !e(n).is(":focus"))
        );
      }),
      (B = function () {
        var t = e(this),
        ...
        e(".mCSB_" + n.idx + "_scrollbar ." + l[12])
          ...
          .bind("click." + i, function (i) {
            if (
              e(i.target).hasClass(l[12]) ||
              e(i.target).hasClass("mCSB_draggerRail")
            ) {
              F(t);
              var s = e(this),
              ...
              if (s.parent(".mCSB_scrollTools_horizontal").length > 0) {
                ...
                var c = "x",
                  d = i.pageX > a.offset().left ? -1 : 1,
                  u = Math.abs(o[0].offsetLeft) - d * (0.9 * r.width());
              } else {
                if (!n.overflowed[0]) return;
                (c = "y"),
                  (d = i.pageY > a.offset().top ? -1 : 1),
                  (u = Math.abs(o[0].offsetTop) - d * (0.9 * r.height()));
              }
              U(t, u.toString(), { dir: c, scrollEasing: "mcsEaseInOut" });
            }
          });
      }),
      (H = function () {
          ...
          o.is(i.advanced.autoScrollOnFocus) &&
            ...
            (t[0]._focusTimeout = setTimeout(function () {
              var e = [Z(o)[0], Z(o)[1]],
                ...
                a = [
                  n[0] + e[0] >= 0 &&
                    n[0] + e[0] < s.height() - o.outerHeight(!1),
                  n[1] + e[1] >= 0 &&
                    n[0] + e[1] < s.width() - o.outerWidth(!1),
                ],
      ...
      (P = function () {
        var t = e(this).data("mCS"),
          n = "mCS_" + t.idx,
          i = e("#mCSB_" + t.idx + "_container").parent();
        i.bind("scroll." + n, function (n) {
      ...
      (q = function () {
        ...
        e(s + ">a").bind(
          ...
          function (r) {
            ...
            function l(e, n) {
              (o.scrollAmount = i.snapAmount || i.scrollButtons.scrollAmount),
                I(t, e, n);
            }
          }
        );
          ...
          switch (r.type) {
            ...
            case "keyup":
              ...
              if (
                ...
                if (
                  ((38 === s || 40 === s) && !n.overflowed[0]) ||
                  ((37 === s || 39 === s) && !n.overflowed[1])
                )
                  return;
                "keyup" === r.type && (d = "off"),
                  e(document.activeElement).is(c) ||
                    (r.preventDefault(), r.stopImmediatePropagation(), h(d, s));
              } else if (33 === s || 34 === s) {
                if (
                  ...
                  if (
                    ...
                    var p = "x",
                      f = Math.abs(a[0].offsetLeft) - u * (0.9 * l.width());
                  else
                    (p = "y"),
                      (f = Math.abs(a[0].offsetTop) - u * (0.9 * l.height()));
                  U(t, f.toString(), { dir: p, scrollEasing: "mcsEaseInOut" });
                }
              } else
                (35 !== s && 36 !== s) ||
                  e(document.activeElement).is(c) ||
                  ...
                  ("yx" === i.axis && n.overflowed[1] && !n.overflowed[0])
                    ? ((p = "x"),
                      (f =
                        35 === s ? Math.abs(l.width() - a.outerWidth(!1)) : 0))
                    : ((p = "y"),
                      (f =
                        35 === s
                          ? Math.abs(l.height() - a.outerHeight(!1))
                          : 0)),
                  U(t, f.toString(), { dir: p, scrollEasing: "mcsEaseInOut" }));
          }
          function h(e, r) {
            (o.type = i.keyboard.scrollType),
              ...
              ("stepped" === o.type && n.tweenRunning) || I(t, e, r);
          }
        }
        d.length &&
          d.each(function () {
      ...
      (I = function (t, n, i, o, r) {
        var s = t.data("mCS"),
          ...
          u = "stepped" === c.type,
          p = a.scrollInertia < 26 ? 26 : a.scrollInertia,
          f = a.scrollInertia < 1 ? 17 : a.scrollInertia;
        switch (n) {
          case "on":
            if (
              ((c.dir = [
                i === l[16] || i === l[15] || 39 === i || 37 === i ? "x" : "y",
                i === l[13] || i === l[15] || 38 === i || 37 === i ? -1 : 1,
              ]),
              F(t),
              K(i) && "stepped" === c.type)
            )
          ...
          case "off":
            clearTimeout(c.step),
              G(c, "step"),
              F(t),
              (u || (s.tweenRunning && c.dir)) && h(!0);
        }
        function h(e) {
          var n = "stepped" !== c.type,
            i = r || (e ? (n ? p / 1.5 : f) : 1e3 / 60),
            a = e ? (n ? 7.5 : 40) : 2.5,
            ...
            v =
              "x" === c.dir[0]
                ? l[1] + c.dir[1] * parseInt(c.scrollAmount)
                : l[0] + c.dir[1] * parseInt(c.scrollAmount),
            g = "auto" !== c.scrollAmount ? v : m,
            y = o || (e ? (n ? "mcsLinearOut" : "mcsEaseInOut") : "mcsLinear"),
            w = !!e;
          e && i < 17 && (g = "x" === c.dir[0] ? l[1] : l[0]),
            U(t, g.toString(), {
              dir: c.dir[0],
              scrollEasing: y,
              dur: i,
          ...
          t instanceof Array
            ? (i =
                t.length > 1
                  ...
                  ? [null, t[0]]
                  : [t[0], null])
            : ((i[0] = t.y ? t.y : t.x || "x" === n.axis ? null : t),
        ...
        if (null != t && void 0 !== t) {
          ...
          switch (l) {
            ...
            case "object":
              ...
              return "x" === n ? Z(h)[1] : Z(h)[0];
            case "string":
            case "number":
              if (K(t)) return Math.abs(t);
              if (-1 !== t.indexOf("%"))
              ...
              if (-1 !== t.indexOf("px") && K(t.split("px")[0]))
                return Math.abs(t.split("px")[0]);
              if ("top" === t || "left" === t) return 0;
              if ("bottom" === t)
                return Math.abs(a.height() - s.outerHeight(!1));
              ...
              return e(t).length
                ? "x" === n
                  ? Z(e(t))[1]
                  : Z(e(t))[0]
                : (s.css(p, t), void c.update.call(null, i[0]));
          }
        }
      }),
      (z = function (t) {
        var n = e(this),
          ...
          o = i.opt,
          r = e("#mCSB_" + i.idx + "_container");
        if (t) return clearTimeout(r[0].autoUpdate), void G(r[0], "autoUpdate");
        var s,
          a,
          d,
          u = r.parent(),
          ...
          f = function () {
            return [
              p[0].is(":visible") ? p[0].outerHeight(!0) : 0,
              p[1].is(":visible") ? p[1].outerWidth(!0) : 0,
            ];
          },
          h = y(),
          m = [
        ...
        function g() {
          var e = 0;
          return o.advanced.updateOnImageLoad && (e = r.find("img").length), e;
        }
        function y() {
          !0 === o.advanced.updateOnSelectorChange &&
            (o.advanced.updateOnSelectorChange = "*");
          var t = 0,
            n = r.find(o.advanced.updateOnSelectorChange);
          return (
            o.advanced.updateOnSelectorChange &&
              n.length > 0 &&
              n.each(function () {
        ...
        function w(e) {
          clearTimeout(r[0].autoUpdate), c.update.call(null, n[0], e);
        }
        !(function t() {
          clearTimeout(r[0].autoUpdate),
            (r[0].autoUpdate = setTimeout(function () {
              if (o.advanced.updateOnSelectorChange && (s = y()) !== h)
                return w(3), void (h = s);
                    ...
                    !(function (t) {
                      if (e(t).hasClass(l[2])) w();
                        ...
                        (o.onload =
                          ((n = o),
                          (i = function () {
                            (this.onload = null), e(t).addClass(l[2]), w(2);
                          }),
                          function () {
      ...
      (U = function (t, n, i) {
        var o = t.data("mCS"),
          ...
          a = [(i = e.extend(s, i)).dur, i.drag ? 0 : i.dur],
          l = e("#mCSB_" + o.idx),
          c = e("#mCSB_" + o.idx + "_container"),
          d = c.parent(),
          u = r.callbacks.onTotalScrollOffset
            ? R.call(t, r.callbacks.onTotalScrollOffset)
            : [0, 0],
        ...
        if (
          ...
          (0 === d.scrollTop() && 0 === d.scrollLeft()) ||
            (e(".mCSB_" + o.idx + "_scrollbar").css("visibility", "visible"),
            d.scrollTop(0).scrollLeft(0)),
          "_resetY" !== n ||
            o.contentReset.y ||
            (C("onOverflowYNone") && r.callbacks.onOverflowYNone.call(t[0]),
            (o.contentReset.y = 1)),
          "_resetX" !== n ||
            o.contentReset.x ||
            (C("onOverflowXNone") && r.callbacks.onOverflowXNone.call(t[0]),
            (o.contentReset.x = 1)),
          "_resetY" !== n && "_resetX" !== n)
        ) {
          switch (
            ((!o.contentReset.y && t[0].mcs) ||
              !o.overflowed[0] ||
              (C("onOverflowY") && r.callbacks.onOverflowY.call(t[0]),
              (o.contentReset.x = null)),
            (!o.contentReset.x && t[0].mcs) ||
              !o.overflowed[1] ||
              (C("onOverflowX") && r.callbacks.onOverflowX.call(t[0]),
              (o.contentReset.x = null)),
            r.snapAmount &&
              (n = (function (e, t, n) {
                return Math.round(e / t) * t - n;
              })(n, r.snapAmount, r.snapOffset)),
            i.dir)
          ) {
            case "x":
              var f = e("#mCSB_" + o.idx + "_dragger_horizontal"),
                h = "left",
                m = c[0].offsetLeft,
                v = [
                  l.width() - c.outerWidth(!1),
                  f.parent().width() - f.width(),
                ],
                g = [n, 0 === n ? 0 : n / o.scrollRatio.x],
                y = u[1],
                w = p[1],
                x = y > 0 ? y / o.scrollRatio.x : 0,
                b = w > 0 ? w / o.scrollRatio.x : 0;
              break;
            case "y":
              (f = e("#mCSB_" + o.idx + "_dragger_vertical")),
                (h = "top"),
                (m = c[0].offsetTop),
                (v = [
                  l.height() - c.outerHeight(!1),
                  f.parent().height() - f.height(),
                ]),
                (g = [n, 0 === n ? 0 : n / o.scrollRatio.y]),
                (y = u[0]),
                (w = p[0]),
                (x = y > 0 ? y / o.scrollRatio.y : 0),
                (b = w > 0 ? w / o.scrollRatio.y : 0);
          }
          g[1] < 0 || (0 === g[0] && 0 === g[1])
            ? (g = [0, 0])
            : g[1] >= v[1]
            ? (g = [v[0], v[1]])
            : (g[0] = -g[0]),
            t[0].mcs || (T(), C("onInit") && r.callbacks.onInit.call(t[0])),
            clearTimeout(c[0].onCompleteTimeout),
            (!o.tweenRunning &&
              ((0 === m && g[0] >= 0) || (m === v[0] && g[0] <= v[0]))) ||
              (X(f[0], h, Math.round(g[1]), a[1], i.scrollEasing),
              X(c[0], h, Math.round(g[0]), a[0], i.scrollEasing, i.overwrite, {
                onStart: function () {
                  i.callbacks &&
                    i.onStart &&
                    !o.tweenRunning &&
                    (C("onScrollStart") &&
                      (T(), r.callbacks.onScrollStart.call(t[0])),
                    (o.tweenRunning = !0),
                    S(f),
                    (o.cbOffsets = [
                      r.callbacks.alwaysTriggerOffsets || m >= v[0] + y,
                      r.callbacks.alwaysTriggerOffsets || m <= -w,
                    ]));
                },
                onUpdate: function () {
                  i.callbacks &&
                    i.onUpdate &&
                    C("whileScrolling") &&
                    (T(), r.callbacks.whileScrolling.call(t[0]));
                },
                onComplete: function () {
                  if (i.callbacks && i.onComplete) {
                    ...
                    c[0].onCompleteTimeout = setTimeout(function () {
                      C("onScroll") && (T(), r.callbacks.onScroll.call(t[0])),
                        C("onTotalScroll") &&
                          g[1] >= v[1] - x &&
                          o.cbOffsets[0] &&
                          (T(), r.callbacks.onTotalScroll.call(t[0])),
                        C("onTotalScrollBack") &&
                          g[1] <= b &&
                          o.cbOffsets[1] &&
                          (T(), r.callbacks.onTotalScrollBack.call(t[0])),
                        (o.tweenRunning = !1),
                        (c[0].idleTimer = 0),
                        S(f, "hide");
                    }, e);
        ...
        function T() {
          var e = [c[0].offsetTop, c[0].offsetLeft],
            n = [f[0].offsetTop, f[0].offsetLeft],
          ...
          t[0].mcs = {
            ...
            draggerLeft: n[1],
            topPct: Math.round(
              (100 * Math.abs(e[0])) / (Math.abs(o[0]) - r[0])
            ),
            leftPct: Math.round(
              (100 * Math.abs(e[1])) / (Math.abs(o[1]) - r[1])
            ),
            direction: i.dir,
          };
        }
      }),
      (X = function (e, t, n, i, o, r, s) {
        e._mTween || (e._mTween = { top: {}, left: {} });
        var a,
          l,
          c = (s = s || {}).onStart || function () {},
        ...
        function y() {
          v.stop ||
            ...
            w(),
            f >= v.time &&
              ((v.time = f > v.time ? f + a - (f - v.time) : f + a - 1),
              v.time < f + 1 && (v.time = f + 1)),
            v.time < i ? (v.id = l(y)) : u.call());
        }
        function w() {
          i > 0
            ? ((v.currVal = (function (e, t, n, i, o) {
                switch (o) {
                  case "linear":
                  case "mcsLinear":
                    return (n * e) / i + t;
      ...
      (e.fn[n] = function (t) {
        return c[t]
          ? c[t].apply(this, Array.prototype.slice.call(arguments, 1))
          : "object" != typeof t && t
            ...
            mcsInView:
              ...
              function (t) {
                ...
                if (r.length)
                  return (
                    (n = r.parent()),
                    (i = [r[0].offsetTop, r[0].offsetLeft])[0] + Z(o)[0] >= 0 &&
                      i[0] + Z(o)[0] < n.height() - o.outerHeight(!1) &&
                      i[1] + Z(o)[1] >= 0 &&
                      i[1] + Z(o)[1] < n.width() - o.outerWidth(!1)
                  );
              },
            mcsOverflow:
              e.expr[":"].mcsOverflow ||
