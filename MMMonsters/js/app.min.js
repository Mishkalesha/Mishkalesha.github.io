...
!(function (t, e) {
  ...
  var _ = (function (t) {
    ...
    try {
      $.apply((O = M.call(x.childNodes)), x.childNodes),
    ...
    function at(t, e, i, o) {
      ...
      if (
        !o &&
        ((e ? e.ownerDocument || e : x) !== f && d(e), (e = e || f), g)
      ) {
        if (11 !== C && (h = J.exec(t)))
          if ((r = h[1])) {
            if (9 === C) {
        ...
        if (
          ...
          if (((y = t), (v = e), 1 === C && U.test(t))) {
            for (
              ...
              p[a] = "#" + u + " " + bt(p[a]);
            (y = p.join(",")), (v = (tt.test(t) && yt(e.parentNode)) || e);
          }
          try {
            return $.apply(i, v.querySelectorAll(y)), i;
          } catch (e) {
            A(t, !0);
          } finally {
      ...
      return (
        ...
        ct(function (r, s, a, l) {
          var c,
            ...
            m = !t || (!r && e) ? g : Ct(g, d, t, a, l),
            y = n ? (o || (r ? t : p || i) ? [] : s) : m;
          if ((n && n(m, y, a, l), i))
            for (c = Ct(y, f), i(c, [], a, l), u = c.length; u--; )
              (h = c[u]) && (y[f[u]] = !(m[f[u]] = h));
          if (r) {
            if (o || t) {
              if (o) {
          ...
          } else (y = Ct(y === s ? y.splice(p, y.length) : y)), o ? o(null, s, y, l) : $.apply(s, y);
        })
      );
    }
    function _t(t) {
          ...
          (m = E(
            ...
            (u = function (t, e, n, s, u) {
              ...
              for (
                ...
                if (l && h) {
                  for (
                    p = 0, e || h.ownerDocument === f || (d(h), (n = !g));
                    (m = o[p++]);
                ...
                a && ((h = !m && h) && y--, t && b.push(h));
              }
              if (((y += v), a && v !== y)) {
                for (p = 0; (m = r[p++]); ) m(b, w, e, n);
                if (t) {
                  if (0 < y) for (; v--; ) b[v] || w[v] || (w[v] = k.call(s));
                  w = Ct(w);
                }
                $.apply(s, w),
                  u &&
          ...
          for (
            ...
            if (
              ...
              (o = h(
                ...
                (tt.test(l[0].type) && yt(e.parentNode)) || e
              ))
            ) {
  ...
  (x.filter = function (t, e, n) {
    ...
    x.fn.extend({
      ...
      is: function (t) {
        return !!O(this, "string" == typeof t && A.test(t) ? x(t) : t || [], !1)
          .length;
      },
    });
  var k,
      ...
      function (t, e) {
        x.fn[t] = function (n, i) {
          ...
          return (
            ...
            1 < this.length &&
              (M[t] || x.uniqueSort(o), $.test(t) && o.reverse()),
            this.pushStack(o)
          );
        };
      }
        ...
        var n = [
          ...
          o = {
            ...
            then: function (e, i, o) {
              ...
              return x
                .Deferred(function (t) {
                  n[0][3].add(s(0, t, g(o) ? o : F, t.notifyWith)),
                    n[1][3].add(s(0, t, g(e) ? e : F)),
                    n[2][3].add(s(0, t, g(i) ? i : L));
                })
                .promise();
            },
            promise: function (t) {
      ...
      when: function (t) {
        var e = arguments.length,
          ...
          a = function (t) {
            return function (n) {
              (i[t] = this),
                (o[t] = 1 < arguments.length ? r.call(arguments) : n),
                --e || s.resolveWith(i, o);
            };
          };
        if (
          e <= 1 &&
          (j(t, s.done(a(n)).resolve, s.reject, !e),
  ...
  var q = function (t, e, n, i, o, r, s) {
      var a = 0,
        ...
        c = null == n;
      if ("object" === b(n))
        for (a in ((o = !0), n)) q(t, e, a, n[a], !0, r, s);
      else if (
        void 0 !== i &&
        ((o = !0),
        g(i) || (s = !0),
  ...
  function X(t) {
    return t.replace(W, "ms-").replace(U, V);
  }
  var Y = function (t) {
    ...
    x.fn.extend({
      data: function (t, e) {
        ...
        if (void 0 === t) {
          if (
            this.length &&
            ((o = Z.get(r)), 1 === r.nodeType && !Q.get(r, "hasDataAttrs"))
          ) {
            for (n = s.length; n--; )
              s[n] &&
                0 === (i = s[n].name).indexOf("data-") &&
                ((i = X(i.slice(5))), tt(r, i, o[i]));
  ...
  ot.getRootNode &&
    (rt = function (t) {
      return (
        x.contains(t.ownerDocument, t) || t.getRootNode(st) === t.ownerDocument
      );
    });
  var at = function (t, e) {
      return (
        "none" === (t = e || t).style.display ||
        ("" === t.style.display && rt(t) && "none" === x.css(t, "display"))
      );
    },
    lt = function (t, e, n, i) {
      var o,
  ...
  function xt(t, e, n, i, o) {
    ...
    for (h.textContent = "", f = 0; (r = d[f++]); )
      if (i && -1 < x.inArray(r, i)) o && o.push(r);
        ...
        ((c = rt(r)), (s = mt(h.appendChild(r), "script")), c && yt(s), n)
      )
        for (u = 0; (r = s[u++]); ) pt.test(r.type || "") && n.push(r);
    return h;
  }
  (vt = i.createDocumentFragment().appendChild(i.createElement("div"))),
    (bt = i.createElement("input")).setAttribute("type", "radio"),
          ...
          handler: function (t) {
            ...
            if (1 & t.isTrigger && this[e]) {
              if (s.length)
                ...
                (i = n(this, e)),
                this[e](),
                s !== (o = Q.get(this, e)) || i ? Q.set(this, e, !1) : (o = {}),
                s !== o)
              )
                return (
  ...
  (x.event = {
    ...
    dispatch: function (t) {
      ...
      if (
        ...
        for (
          s = x.event.handlers.call(this, a, c), e = 0;
    ...
    special: {
      ...
      click: {
        setup: function (t) {
          var e = this || t;
          return (
            dt.test(e.type) && e.click && D(e, "input") && Pt(e, "click", Tt),
            !1
          );
        },
        trigger: function (t) {
          var e = this || t;
          return (
            dt.test(e.type) && e.click && D(e, "input") && Pt(e, "click"), !0
          );
        },
        _default: function (t) {
          var e = t.target;
  ...
  function Lt(t, e, n, i) {
    ...
    var o,
      ...
      m = e[0],
      y = g(m);
    if (y || (1 < d && "string" == typeof m && !p.checkClone && It.test(m)))
      return t.each(function (o) {
        var r = t.eq(o);
        y && (e[0] = m.call(this, o, r.html())), Lt(r, e, n, i);
      });
    if (
      d &&
      ((r = (o = xt(e, t[0].ownerDocument, !1, t, i)).firstChild),
      1 === o.childNodes.length && (o = r),
      r || i)
    ) {
      for (l = (a = x.map(mt(o, "script"), Nt)).length; h < d; h++)
        (c = o),
          h !== f &&
            ((c = x.clone(c, !0, !0)), l && x.merge(a, mt(c, "script"))),
          n.call(t[h], c, h);
      if (l)
        for (u = a[a.length - 1].ownerDocument, x.map(a, Rt), h = 0; h < l; h++)
          (c = a[h]),
            pt.test(c.type || "") &&
  ...
  function jt(t, e, n) {
    for (var i, o = e ? x.filter(e, t) : t, r = 0; null != (i = o[r]); r++)
      n || 1 !== i.nodeType || x.cleanData(mt(i)),
        i.parentNode &&
          (n && rt(i) && yt(mt(i, "script")), i.parentNode.removeChild(i));
    return t;
  }
  x.extend({
    ...
    clone: function (t, e, n) {
      ...
      if (e)
        if (n)
          for (r = r || mt(t), s = s || mt(u), i = 0, o = r.length; i < o; i++)
            Ft(r[i], s[i]);
        else Ft(t, u);
      return (
        0 < (s = mt(u, "script")).length && yt(s, !h && mt(t, "script")), u
      );
    },
    ...
    x.each(
      ...
      function (t, e) {
        x.fn[t] = function (t) {
          for (var n, i = [], o = x(t), r = o.length - 1, s = 0; s <= r; s++)
  ...
  function te(t, e, n, i, o, r) {
    ...
    for (; s < 4; s += 2)
      "margin" === n && (l += x.css(t, n + it[s], !0, o)),
        i
          ? ("content" === n && (l -= x.css(t, "padding" + it[s], !0, o)),
            "margin" !== n &&
              (l -= x.css(t, "border" + it[s] + "Width", !0, o)))
          : ((l += x.css(t, "padding" + it[s], !0, o)),
            "padding" !== n
              ? (l += x.css(t, "border" + it[s] + "Width", !0, o))
              : (a += x.css(t, "border" + it[s] + "Width", !0, o)));
    return (
      !i &&
        0 <= r &&
        (l +=
  ...
  x.extend({
    ...
    style: function (t, e, n, i) {
      if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
        var o,
          ...
          c = t.style;
        if (
          (l || (e = Yt(a)), (s = x.cssHooks[e] || x.cssHooks[a]), void 0 === n)
        )
    ...
    x.each(["height", "width"], function (t, e) {
      x.cssHooks[e] = {
        get: function (t, n, i) {
          if (n)
            return !Gt.test(x.css(t, "display")) ||
      ...
      _default: {
        ...
        set: function (t) {
          x.fx.step[t.prop]
            ? x.fx.step[t.prop](t)
            : 1 !== t.elem.nodeType ||
              (!x.cssHooks[t.prop] && null == t.elem.style[Yt(t.prop)])
            ? (t.elem[t.prop] = t.now)
        ...
        if ((l = !x.isEmptyObject(e)) || !x.isEmptyObject(f))
          ...
          f))
            l ||
              ...
              g && ht([t], !0),
              d.done(function () {
                for (i in (g || ht([t]), Q.remove(t, "fxshow"), f))
                  x.style(t, i, f[i]);
              })),
              (l = de(g ? m[i] : 0, i, d)),
              i in m ||
      ...
      stop: function (t, e, n) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (o in s) s[o] && s[o].stop && le.test(o) && i(s[o]);
            for (o = r.length; o--; )
              r[o].elem !== this ||
                (null != t && r[o].queue !== t) ||
    ...
    x.fn.extend({
      ...
      hasClass: function (t) {
        var e,
          ...
          i = 0;
        for (e = " " + t + " "; (n = this[i++]); )
          if (1 === n.nodeType && -1 < (" " + ve(be(n)) + " ").indexOf(e))
            return !0;
        return !1;
      },
    });
  ...
  x.extend(x.event, {
    trigger: function (e, n, o, r) {
      ...
      if (
        ...
        if (!r && !f.noBubble && !m(o)) {
          for (
            c = f.delegateType || v, Ce.test(c + v) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            y.push(a), (l = a);
        ...
        return (
          ...
          r ||
            ...
            (u &&
              ...
              ((l = o[u]) && (o[u] = null),
              (x.event.triggered = v),
              e.isPropagationStopped() && p.addEventListener(v, Se),
              o[v](),
              e.isPropagationStopped() && p.removeEventListener(v, Se),
  ...
  function ke(t, e, n, i) {
    ...
    else for (o in e) ke(t + "[" + o + "]", e[o], n, i);
  }
    ...
    x.extend({
      ...
      ajax: function (e, n) {
        ...
        if (
          ...
          if (((_.readyState = 1), h && m.trigger("ajaxSend", [_, p]), u))
            return _;
          p.async &&
            0 < p.timeout &&
            ...
            c
              ? (p.ifModified &&
                  ((C = _.getResponseHeader("Last-Modified")) &&
                    (x.lastModified[r] = C),
                  (C = _.getResponseHeader("etag")) && (x.etag[r] = C)),
                204 === e || "HEAD" === p.type
                  ? (S = "nocontent")
                  : 304 === e
                  ? (S = "notmodified")
                  : ((S = w.state), (d = w.data), (c = !(f = w.error))))
              : ((f = S), (!e && S) || ((S = "error"), e < 0 && (e = 0))),
            (_.status = e),
            (_.statusText = (n || S) + ""),
            c ? y.resolveWith(g, [d, S, _]) : y.rejectWith(g, [_, S, f]),
            _.statusCode(b),
            (b = void 0),
            h && m.trigger(c ? "ajaxSuccess" : "ajaxError", [_, p, c ? d : f]),
            v.fireWith(g, [_, S]),
            h &&
  ...
  x.ajaxSetup({
        ...
        return (
          ...
          i.always(function () {
            void 0 === r ? x(t).removeProp(o) : (t[o] = r),
              e[o] && ((e.jsonpCallback = n.jsonpCallback), Ye.push(o)),
              s && g(r) && r(s[0]),
              (s = r = void 0);
          }),
          "script"
    ...
    (p.createHTMLDocument =
      (((Xe = i.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
    ...
    (x.parseHTML = function (t, e, n) {
      return "string" != typeof t
        ...
        : ("boolean" == typeof e && ((n = e), (e = !1)),
          e ||
            (p.createHTMLDocument
              ? (((o = (e = i.implementation.createHTMLDocument(
                  ""
    ...
    (x.fn.load = function (t, e, n) {
      var i,
        ...
        a = t.indexOf(" ");
      return (
        -1 < a && ((i = ve(t.slice(a))), (t = t.slice(0, a))),
        g(e)
          ? ((n = e), (e = void 0))
    ...
    x.each(["top", "left"], function (t, e) {
      x.cssHooks[e] = Wt(p.pixelPosition, function (t, n) {
        if (n)
          return (n = qt(t, e)), Bt.test(n) ? x(t).position()[e] + "px" : n;
      });
    }),
  ...
  return (
    (x.noConflict = function (e) {
      return t.$ === x && (t.$ = Ze), e && t.jQuery === x && (t.jQuery = Qe), x;
    }),
    e || (t.jQuery = t.$ = x),
    x
  );
    ...
    return (function t(e, n, i) {
    ...
    })(
      {
            ...
            !(function (t, i) {
              ...
              return (function (t) {
                function e(i) {
                  ...
                  return (
                    t[i].call(o.exports, o, o.exports, e), (o.l = !0), o.exports
                  );
                }
                var n = {};
                return (
                    ...
                    var l = n(1),
                      ...
                      m = function (t, e) {
                        ...
                        d >= h
                          ...
                          : (t._applyFilter("beforeTween"),
                            d < u + o ? ((d = 1), (a = 1), (u = 1)) : (u += o),
                            g(d, i, s, c, a, u, r),
                            t._applyFilter("afterTween"),
                            l(i, n, f));
                      },
                      y = function () {
                        for (var t = w.now(), e = d; e; ) {
                          var n = e._next;
                          m(e, t), (e = n);
                        }
                      },
                      ...
                      b = function (t) {
                        if (t === d)
                          ...
                          (f = t._previous) ? (f._next = null) : (d = null);
                        else {
                          var e = t._previous,
                            n = t._next;
                          ...
                          (n = [
                            {
                              ...
                              value: function (t) {
                                ...
                                try {
                                  for (
                                    var o, r = this._filters[Symbol.iterator]();
                                    !(e = (o = r.next()).done);
                                    e = !0
                                  ) {
                                    var s = o.value[t];
                            ...
                            },
                            {
                              ...
                              value: function () {
                                ...
                                (this._configured = !0),
                                  ...
                                  (this._step = y),
                                  (this._duration = l),
                                  (this._currentState = r({}, u || this.get())),
                                  (this._originalState = this.get()),
                                  (this._targetState = r({}, b || this.get()));
                                ...
                                (this._targetState = r(
                                  ...
                                  (this._easing = v(w, c));
                                var x = t.filters;
                                for (var C in ((this._filters.length = 0), x))
                                  x[C].doesApply(this) &&
                                    this._filters.push(x[C]);
                                return (
                ...
                function (t, e, n) {
                  ...
                  function o(t) {
                    ...
                    [e, t._originalState, t._targetState].forEach(S),
                      (t._tokenData = E(e));
                  }
                  function r(t) {
                    var e = t._currentState,
                  ...
                  var u = {};
                  n.r(u),
                    n.d(u, "doesApply", function () {
                      return M;
                    }),
                    n.d(u, "tweenCreated", function () {
                      return o;
                    }),
                    n.d(u, "beforeTween", function () {
                      return r;
                    }),
                    n.d(u, "afterTween", function () {
                      return s;
                    });
                  var h,
                    d,
                    ...
                    _ = function (t) {
                      var e = t.match(m).map(Math.floor);
                      return "".concat(t.match(v)[0]).concat(e.join(","), ")");
                    },
                    T = function (t) {
                      return t.match(m);
                    },
                    ...
                    F = function (t, e, n, i) {
                      var o =
                        ...
                        s = Object(f.b)(t, i);
                      for (var l in ((N._filters.length = 0),
                      N.set({}),
                      (N._currentState = r),
                      (N._originalState = t),
                      (N._targetState = e),
                      (N._easing = s),
                      R))
                        R[l].doesApply(N) && N._filters.push(R[l]);
                      N._applyFilter("tweenCreated"),
                        N._applyFilter("beforeTween");
                      var c = Object(f.e)(n, r, t, e, 1, o, s);
                      return N._applyFilter("afterTween"), c;
                    },
                    L = (function () {
                      function t() {
                        !(function (t, e) {
                        ...
                        (n = [
                          {
                            key: "add",
                            value: function (t) {
                              return c(this, j).push(t), t;
                            },
                          },
                          {
                            key: "remove",
                            value: function (t) {
                              var e = c(this, j).indexOf(t);
                              return ~e && c(this, j).splice(e, 1), t;
                            },
                          },
                          {
                            key: "empty",
                          ...
                          },
                          {
                            key: "isPlaying",
                            value: function () {
                              return c(this, j).some(function (t) {
                                return t.isPlaying();
                              });
                            },
                          },
                          ...
                          },
                          {
                            key: "promises",
                            get: function () {
                              return c(this, j).map(function (t) {
                                return t._promise;
                              });
                            },
                          },
        ...
        9: [
          function (t, e, n) {
            function i(t, e, n) {
              for (var i = t.style, r = 0; r < a.length; ++r)
                i[a[r] + o(e)] = n;
              i[e] = n;
            }
            function o(t) {
  ...
  (function (t) {
    ...
    !(function () {
          ...
          (Object.keys = (function () {
            ...
            return (
              ...
              function (o) {
                ...
                for (s in o) i.call(o, s) && r.push(s);
                if (t) for (a = 0; a < n; a++) i.call(o, e[a]) && r.push(e[a]);
                return r;
              }
            );
          })()),
      ...
      ((e = function (i, o, r) {
        ...
        for (p = 0; (s = f[p]) && (!(p > 0) || a); p++)
          s.id ? (d = s.id) : ((d = "MixItUp" + n.randomHex()), (s.id = d)),
            e.instances[d] instanceof e.Mixer
              ? ((l = e.instances[d]),
                (!o || (o && o.debug && !1 !== o.debug.showWarnings)) &&
                  console.warn(e.messages.warningFactoryPreexistingInstance()))
              : ((l = new e.Mixer()).attach(s, u, d, o), (e.instances[d] = l)),
            (c = new e.Facade(l)),
      ...
      (n = {
        ...
        extend: function (t, e, n, i) {
          ...
          (n = n || !1), (i = i || !1);
          try {
            if (Array.isArray(e)) for (s = 0; s < e.length; s++) o.push(s);
            else e && (o = Object.keys(e));
            for (s = 0; s < o.length; s++)
              (r = o[s]),
                !n || "object" != typeof e[r] || this.isElement(e[r])
                  ? (t[r] = e[r])
                  : Array.isArray(e[r])
                  ? (t[r] || (t[r] = []), this.extend(t[r], e[r], n, i))
                  : (t[r] || (t[r] = {}), this.extend(t[r], e[r], n, i));
          } catch (e) {
            if (!i) throw e;
        ...
        getCustomEvent: function (e, n, i) {
          ...
          return (
            ...
            "function" == typeof t.CustomEvent
              ? (o = new t.CustomEvent(e, {
                  detail: n,
                  bubbles: !0,
                  cancelable: !0,
                }))
              : "function" == typeof i.createEvent
              ? (o = i.createEvent("CustomEvent")).initCustomEvent(e, !0, !0, n)
              : (((o = i.createEventObject()).type = e),
                (o.returnValue = !1),
                (o.cancelBubble = !1),
                (o.detail = n)),
            o
        ...
        createElement: function (e, n) {
          var i = null,
            o = null;
          for (
            i = (n = n || t.document).createDocumentFragment(),
              (o = n.createElement("div")).innerHTML = e.trim();
            o.firstChild;
        ...
        position: function (t) {
          for (var e = 0, n = 0, i = t; t; )
            (e -= t.scrollLeft),
              (n -= t.scrollTop),
              t === i &&
                ((e += t.offsetLeft), (n += t.offsetTop), (i = t.offsetParent)),
              (t = t.parentElement);
          return { x: e, y: n };
        },
        ...
        children: function (e, n, i) {
          ...
          return (
            (i = i || t.doc),
            e &&
              (e.id || ((r = "Temp" + this.randomHexKey()), (e.id = r)),
              (o = i.querySelectorAll("#" + e.id + " > " + n)),
        ...
        defer: function (n) {
          ...
          return (
            ...
            e.features.has.promises
              ...
              : (r = t.jQuery || n.$) && "function" == typeof r.Deferred
              ? ((i = r.Deferred()),
                (o.promise = i.promise()),
                (o.resolve = i.resolve),
                (o.reject = i.reject))
        ...
        all: function (n, i) {
          ...
          return e.features.has.promises
            ? Promise.all(n)
            : (o = t.jQuery || i.$) && "function" == typeof o.when
      ...
      (e.Base.prototype = {
        ...
        callActions: function (t, e) {
          var i = this.constructor.actions[t],
            o = "";
          if (i && !n.isEmptyObject(i)) for (o in i) i[o].apply(this, e);
        },
      ...
      (e.ControlDefinition = function (t, i, o, r) {
        e.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.type = t),
          (this.selector = i),
      ...
      n.extend(e.Control.prototype, {
        ...
        removeBinding: function (t) {
          ...
          this.callActions("beforeRemoveBinding", arguments),
            (i = n.bound.indexOf(t)) > -1 && n.bound.splice(i, 1),
            n.bound.length < 1 &&
              (n.unbindClick(),
              (i = e.controls.indexOf(n)),
              e.controls.splice(i, 1),
        ...
        handleClick: function (t) {
          ...
          if (
            ...
            (o = i.selector
              ? n.closestParent(
                  t.target,
                  r.config.selectors.control + i.selector,
                  !0,
                  r.dom.document
                )
              : i.el))
            ...
            switch (i.type) {
              ...
              case "toggle":
                (a.filter = i.filter || o.getAttribute("data-toggle")),
                  (s =
                    "live" === i.status
                      ? n.hasClass(o, i.classNames.active)
                      : "active" === i.status);
            }
            for (u = 0; u < i.bound.length; u++)
              (l = new e.CommandMultimix()), n.extend(l, a), c.push(l);
            for (
              c = i.callFilters("commandsHandleClick", c, arguments),
            ...
            i.pending > 0 ||
              ("live" === i.status
                ...
                : ((o.sort = i.sort),
                  ...
                  i.parseStatusChange(i.el, t, o, n)),
        ...
        updateLive: function (t, n) {
          ...
          if ((i.callActions("beforeUpdateLive", arguments), i.el)) {
            for (
              o = i.el.querySelectorAll(i.selector), a = 0;
              (s = o[a]);
              a++
            ) {
          ...
          switch (
            ...
            case "sort":
              e.sort.match(/:asc/g) && (r = e.sort.replace(/:asc/g, "")),
                e.sort === n.sort || r === n.sort
                  ? o.renderStatus(t, "active")
                  : o.renderStatus(t, "inactive");
              break;
            case "toggle":
              for (
                i.length < 1 && o.renderStatus(t, "inactive"),
        ...
        renderStatus: function (t, e) {
          ...
          switch ((i.callActions("beforeRenderStatus", arguments), e)) {
            case "active":
              n.addClass(t, i.classNames.active),
                n.removeClass(t, i.classNames.disabled),
                i.canDisable && (i.el.disabled = !1);
              break;
            case "inactive":
              n.removeClass(t, i.classNames.active),
                n.removeClass(t, i.classNames.disabled),
                i.canDisable && (i.el.disabled = !1);
              break;
            case "disabled":
              i.canDisable && (i.el.disabled = !0),
                n.addClass(t, i.classNames.disabled),
                n.removeClass(t, i.classNames.active);
          }
      ...
      (e.Events.prototype.fire = function (t, i, o, r) {
        var s = this,
          a = null,
          l = new e.EventDetail();
        if ((s.callActions("beforeFire", arguments), void 0 === s[t]))
          throw new Error('Event type "' + t + '" not found.');
        (l.state = new e.State()),
          n.extend(l.state, o.state),
          o.futureState &&
            ((l.futureState = new e.State()),
            n.extend(l.futureState, o.futureState)),
          (l.instance = o.instance),
          o.originalEvent && (l.originalEvent = o.originalEvent),
          (a = n.getCustomEvent(t, l, r)),
      ...
      n.extend(e.Mixer.prototype, {
        ...
        getInitialState: function () {
          ...
          if (
            ...
            (i.startDataset = i.newDataset = n.activeDataset = t.config.load.dataset.slice()),
            ...
            (n.activeFilter = t.parseFilterArgs([
              ...
              "desc" === n.activeSort.order
                ? ((i.newSort = n.activeSort),
                  t.sortOperation(i),
                  t.printSort(!1, i),
                  (t.targets = i.newOrder))
                : (i.startOrder = i.newOrder = t.targets),
              (i.startFilter = i.newFilter = n.activeFilter),
              (i.startSort = i.newSort = n.activeSort),
              (i.startContainerClassName = i.newContainerClassName =
                n.activeContainerClassName),
          ...
          return (
            (i = t.callFilters("operationGetInitialState", i, [n])),
            (t.lastOperation = i),
        ...
        indexTargets: function () {
          ...
          if (t.dom.targets.length) {
            for (s = 0; (o = t.dom.targets[s]); s++)
              (i = new e.Target()).init(o, t, r ? r[s] : void 0),
                (i.isInDom = !0),
                t.targets.push(i);
            t.dom.parent =
        ...
        initControls: function () {
          ...
          for (l = 0; (n = e.controlDefinitions[l]); l++)
            if (t.config.controls.live || n.live) {
              ...
              for (
                i = r.querySelectorAll(t.config.selectors.control + n.selector),
                  c = 0;
                (o = i[c]);
                c++
              )
        ...
        getControl: function (t, i, o) {
          ...
          if ((r.callActions("beforeGetControl", arguments), !o))
            for (a = 0; (s = e.controls[a]); a++) {
              ...
              if (s.el === t && s.type === i && s.selector === o)
                return (
                  s.addBinding(r),
          ...
          return (
            (s = new e.Control()).init(t, i, o),
            (s.classNames.base = n.getClassname(r.config.classNames, i)),
            (s.classNames.active = n.getClassname(
              r.config.classNames,
              i,
              r.config.classNames.modifierActive
            )),
            (s.classNames.disabled = n.getClassname(
              r.config.classNames,
              i,
              r.config.classNames.modifierDisabled
            )),
            s.addBinding(r),
            r.callFilters("controlGetControl", s, arguments)
          );
        ...
        buildToggleArray: function (t, e) {
          ...
          (o !== i.config.selectors.target && "all" !== o) || (o = ""),
            ...
            (i.toggleArray = n.clean(i.toggleArray)),
        ...
        updateControls: function (t) {
          ...
          for (
            i.callActions("beforeUpdateControls", arguments),
              t.filter
                ? (r.filter = t.filter.selector)
                : (r.filter = i.state.activeFilter.selector),
              t.sort
                ? (r.sort = i.buildSortString(t.sort))
                : (r.sort = i.buildSortString(i.state.activeSort)),
              r.filter === i.config.selectors.target && (r.filter = "all"),
        ...
        insertTargets: function (t, i) {
          ...
          if (
            ...
            (s = r ? n.index(r, o.config.selectors.target) : o.targets.length),
            t.collection)
          ) {
            for (u = 0; (c = t.collection[u]); u++) {
              ...
              (c.style.display = "none"),
                ...
                n.isElement(c, o.dom.document) &&
                  c.matches(o.config.selectors.target) &&
                  ((l = new e.Target()).init(c, o),
                  (l.isInDom = !0),
          ...
          (i.startOrder = o.origOrder = o.targets),
            ...
            e && "before" === n
              ...
              : 0 === i.targets.length &&
                ...
                (i.config.layout.siblingAfter
                  ? (o = i.config.layout.siblingAfter)
                  : i.config.layout.siblingBefore
                  ? (o = i.config.layout.siblingBefore.nextElementSibling)
        ...
        filterOperation: function (t) {
          ...
          for (
            ...
            (n = t.newFilter.collection
              ? t.newFilter.collection.indexOf(r.dom.el) > -1
              : "" !== t.newFilter.selector &&
                r.dom.el.matches(t.newFilter.selector)),
        ...
        compare: function (t, e, n) {
          ...
          return (
            isNaN(1 * r) || isNaN(1 * s)
              ? ((r = r.toLowerCase()), (s = s.toLowerCase()))
              : ((r *= 1), (s *= 1)),
            r < s
              ? "asc" === o
                ? -1
        ...
        getAttributeValue: function (t, n) {
          var i = this,
            o = "";
          return (
            null === (o = t.dom.el.getAttribute("data-" + n)) &&
        ...
        printSort: function (e, i) {
          ...
          for (
            ...
            "absolute" !== (h = u.dom.el).style.position &&
              (n.removeWhitespace(h.previousSibling),
              h.parentElement.removeChild(h));
          for (
            (c = a ? a.previousSibling : o.dom.parent.lastChild) &&
              "#text" === c.nodeName &&
          ...
          o.dom.parent.firstChild &&
            ...
            a
              ? (l.appendChild(t.document.createTextNode(" ")),
                o.dom.parent.insertBefore(l, a))
              : o.dom.parent.appendChild(l),
        ...
        parseSortString: function (t, i) {
          ...
          for (l = 0; l < r.length; l++) {
            ...
            l < r.length - 1 &&
              ((s.next = new e.CommandSort()), n.freeze(s), (s = s.next));
          }
        ...
        parseEffects: function () {
          ...
          for (n in (t.callActions("beforeParseEffects", arguments),
          ...
          e.transformDefaults))
            e.transformDefaults[n] instanceof e.TransformData &&
              (t.parseEffect(n, i, t.effectsIn, t.transformIn),
              t.parseEffect(n, o, t.effectsOut, t.transformOut, !0));
        ...
        parseEffect: function (t, n, i, o, r) {
          var s = this,
            ...
            f = -1;
          if (
            (s.callActions("beforeParseEffect", arguments),
            "string" != typeof n)
          )
            throw new TypeError(
              e.messages.errorConfigInvalidAnimationEffects()
            );
          if (n.indexOf(t) < 0) "stagger" === t && (s.staggerDuration = 0);
          else {
            switch (
              ((l = n.indexOf(t + "(")) > -1 &&
                ((c = n.substring(l)), (u = a.exec(c)[1])),
              t)
            ) {
              case "fade":
              ...
              default:
                if (
                  (r && s.config.animation.reverseOut && "scale" !== t
                    ? (i[t].value =
                        -1 * (u ? parseFloat(u) : e.transformDefaults[t].value))
                    : (i[t].value = u
                        ? parseFloat(u)
        ...
        buildState: function (t) {
          var n = this,
            ...
            r = -1;
          for (
            n.callActions("beforeBuildState", arguments), r = 0;
            (o = n.targets[r]);
            r++
          )
        ...
        goMix: function (i, o) {
          ...
          return (
            ...
            (r.config.animation.duration &&
              r.config.animation.effects &&
              n.isVisible(r.dom.container)) ||
              (i = !1),
            o.toShow.length ||
              o.toHide.length ||
              o.willSort ||
              o.willChangeLayout ||
              (i = !1),
            o.startState.show.length || o.show.length || (i = !1),
            e.events.fire(
              "mixStart",
              r.dom.container,
              { state: o.startState, futureState: o.newState, instance: r },
              r.dom.document
            ),
            "function" == typeof r.config.callbacks.onMixStart &&
              r.config.callbacks.onMixStart.call(
                r.dom.container,
                o.startState,
                o.newState,
                r
            ...
            (s = r.userDeferred
              ? r.userDeferred
              : (r.userDeferred = n.defer(e.libraries))),
            (r.isBusy = !0),
            i && e.features.has.transitions
              ? (t.pageYOffset !== o.docState.scrollTop &&
                  t.scrollTo(o.docState.scrollLeft, o.docState.scrollTop),
                r.config.animation.applyPerspective &&
                  ((r.dom.parent.style[e.features.perspectiveProp] =
                    r.config.animation.perspectiveDistance),
                  (r.dom.parent.style[e.features.perspectiveOriginProp] =
                    r.config.animation.perspectiveOrigin)),
                r.config.animation.animateResizeContainer &&
                  o.startHeight !== o.newHeight &&
                  o.viewportDeltaY !== o.startHeight - o.newHeight &&
                  (r.dom.parent.style.height = o.startHeight + "px"),
                r.config.animation.animateResizeContainer &&
                  o.startWidth !== o.newWidth &&
                  o.viewportDeltaX !== o.startWidth - o.newWidth &&
                  (r.dom.parent.style.width = o.startWidth + "px"),
                o.startHeight === o.newHeight &&
                  (r.dom.parent.style.height = o.startHeight + "px"),
                o.startWidth === o.newWidth &&
                  (r.dom.parent.style.width = o.startWidth + "px"),
                o.startHeight === o.newHeight &&
                  o.startWidth === o.newWidth &&
                  (r.dom.parent.style.overflow = "hidden"),
        ...
        getStartMixData: function (n) {
          ...
          for (
            ...
            (a = s.getPosData()), (n.showPosData[l] = { startPosData: a });
          for (l = 0; (s = n.toHide[l]); l++)
            (a = s.getPosData()), (n.toHidePosData[l] = { startPosData: a });
          (n.startX = r.left),
            (n.startY = r.top),
            (n.startHeight = i.incPadding
              ? r.height
              : r.height -
        ...
        getFinalMixData: function (e) {
          var i = this,
            ...
            a = -1;
          for (
            i.callActions("beforeGetFinalMixData", arguments), a = 0;
            (s = e.show[a]);
            a++
          )
          ...
          for (
            (i.config.animation.clampHeight || i.config.animation.clampWidth) &&
              (i.dom.parent.style.height = i.dom.parent.style.width = i.dom.parent.style.overflow =
                ""),
              i.incPadding || (o = t.getComputedStyle(i.dom.parent)),
              r = i.dom.parent.getBoundingClientRect(),
              e.newX = r.left,
              e.newY = r.top,
              e.newHeight = i.incPadding
                ? r.height
                : r.height -
                  parseFloat(o.paddingTop) -
                  parseFloat(o.paddingBottom) -
          ...
          e.willChangeLayout &&
            (n.removeClass(i.dom.container, e.newContainerClassName),
            n.addClass(i.dom.container, i.config.layout.containerClassName)),
          ...
          for (
            ...
            for (
              (o = t.showPosData[u]).posIn = new e.StyleData(),
                ...
                o.posIn.opacity = i.isShown ? 1 : n.effectsIn.opacity,
                o.posOut.opacity = 1,
              ...
              (a = n.effectsIn[s]) instanceof e.TransformData &&
                a.value &&
          ...
          for (u = 0; (i = t.toHide[u]); u++)
            for (
              (o = t.toHidePosData[u]).posIn = new e.StyleData(),
                ...
                o.posOut.x = n.config.animation.nudge ? 0 : o.posIn.x,
                o.posOut.y = n.config.animation.nudge ? 0 : o.posIn.y,
                o.tweenData.x = o.posOut.x - o.posIn.x,
                o.tweenData.y = o.posOut.y - o.posIn.y,
                n.config.animation.animateResizeTargets &&
                  ((o.posIn.width = o.startPosData.width),
                  ...
                  (o.posIn.marginBottom = o.startPosData.marginBottom - c)),
                o.posIn.opacity = 1,
                o.posOut.opacity = n.effectsOut.opacity,
                o.tweenData.opacity = o.posOut.opacity - o.posIn.opacity,
                h = 0;
              (s = r[h]);
              h++
            )
              (a = n.effectsOut[s]) instanceof e.TransformData &&
                a.value &&
                ((o.posIn[s].value = 0),
        ...
        moveTargets: function (t) {
          var i = this,
            ...
            c = -1,
            u = -1,
            h = i.checkProgress.bind(i);
          for (
            i.callActions("beforeMoveTargets", arguments), u = 0;
            (o = t.show[u]);
            u++
          )
            (r = new e.IMoveData()),
              ...
              (l = i.willTransition(a, t.hasEffect, s.posIn, s.posOut)) && c++,
              o.show(),
              (r.posIn = s.posIn),
              (r.posOut = s.posOut),
              (r.statusChange = a),
          ...
          for (u = 0; (o = t.toHide[u]); u++)
            (s = t.toHidePosData[u]),
              (r = new e.IMoveData()),
              (a = "hide"),
              (l = i.willTransition(a, s.posIn, s.posOut)),
              (r.posIn = s.posIn),
              (r.posOut = s.posOut),
              (r.statusChange = a),
              (r.staggerIndex = u),
          ...
          i.config.animation.animateResizeContainer &&
            ((i.dom.parent.style[e.features.transitionProp] =
              "height " +
            ...
            requestAnimationFrame(function () {
              t.startHeight !== t.newHeight &&
                ...
                (i.dom.parent.style.height = t.newHeight + "px"),
                t.startWidth !== t.newWidth &&
                  t.viewportDeltaX !== t.startWidth - t.newWidth &&
                  (i.dom.parent.style.width = t.newWidth + "px");
            })),
            t.willChangeLayout &&
              (n.removeClass(
                i.dom.container,
              ...
              n.addClass(i.dom.container, t.newContainerClassName)),
        ...
        hasEffect: function () {
          ...
          for (r = 0; (n = e[r]); r++)
            if (
              0 !== ("undefined" !== (i = t.effectsIn[n]).value ? i.value : i)
            ) {
              o = !0;
              break;
            }
          ...
          return (
            (s = !(
              ...
              (!(("none" !== t && e) || i.x !== o.x || i.y !== o.y) &&
                (!r.config.animation.animateResizeTargets ||
                  (i.width === o.width &&
                    i.height === o.height &&
        ...
        cleanUp: function (t) {
          ...
          for (
            i.callActions("beforeCleanUp", arguments),
              i.targetsMoved = i.targetsImmovable = i.targetsBound = i.targetsDone = 0,
              l = 0;
            (o = t.show[l]);
            l++
          )
          ...
          if (
            (t.willSort && i.printSort(!1, t),
            (i.dom.parent.style[
              e.features.transitionProp
            ] = i.dom.parent.style.height = i.dom.parent.style.width = i.dom.parent.style.overflow = i.dom.parent.style[
              e.features.perspectiveProp
            ] = i.dom.parent.style[e.features.perspectiveOriginProp] = ""),
            t.willChangeLayout &&
              (n.removeClass(i.dom.container, t.startContainerClassName),
              n.addClass(i.dom.container, t.newContainerClassName)),
            t.toRemove.length)
          ) {
            for (l = 0; (o = i.targets[l]); l++)
              t.toRemove.indexOf(o) > -1 &&
                ((r = o.dom.el.previousSibling) &&
                  "#text" === r.nodeName &&
                  (s = o.dom.el.nextSibling) &&
                  "#text" === s.nodeName &&
                  n.removeWhitespace(r),
                t.willSort || i.dom.parent.removeChild(o.dom.el),
                i.targets.splice(l, 1),
                (o.isInDom = !1),
                l--);
            i.origOrder = i.targets;
          }
          t.willSort && (i.targets = t.newOrder),
            (i.state = t.newState),
            (i.lastOperation = t),
            ...
            i.queue.length &&
              ...
              (a = i.queue.shift()),
              (i.userDeferred = a.deferred),
              (i.isToggling = a.isToggling),
              (i.lastClicked = a.triggerElement),
              a.instruction.command instanceof e.CommandMultimix
                ? i.multimix.apply(i, a.args)
                : i.dataset.apply(i, a.args)),
        ...
        parseMultimixArgs: function (t) {
          ...
          for (
            o.animate = i.config.animation.enable,
              o.command = new e.CommandMultimix(),
              s = 0;
            s < t.length;
            s++
          )
            null !== (r = t[s]) &&
              ("object" == typeof r
                ...
                : "boolean" == typeof r
                ? (o.animate = r)
                : "function" == typeof r && (o.callback = r));
          return (
            !o.command.insert ||
              o.command.insert instanceof e.CommandInsert ||
              (o.command.insert = i.parseInsertArgs([
                o.command.insert,
              ]).command),
            !o.command.remove ||
              o.command.remove instanceof e.CommandRemove ||
              (o.command.remove = i.parseRemoveArgs([
                o.command.remove,
              ]).command),
            !o.command.filter ||
              o.command.filter instanceof e.CommandFilter ||
              (o.command.filter = i.parseFilterArgs([
                o.command.filter,
              ]).command),
            !o.command.sort ||
              o.command.sort instanceof e.CommandSort ||
              (o.command.sort = i.parseSortArgs([o.command.sort]).command),
            !o.command.changeLayout ||
              o.command.changeLayout instanceof e.CommandChangeLayout ||
        ...
        parseFilterArgs: function (t) {
          ...
          for (
            o.animate = i.config.animation.enable,
              o.command = new e.CommandFilter(),
              s = 0;
            s < t.length;
            s++
          )
            "string" == typeof (r = t[s])
              ? (o.command.selector = r)
              : null === r
              ? (o.command.collection = [])
              : "object" == typeof r && n.isElement(r, i.dom.document)
              ? (o.command.collection = [r])
              : "object" == typeof r && void 0 !== r.length
              ? (o.command.collection = n.arrayFromList(r))
              : "object" == typeof r
              ? n.extend(o.command, r)
              : "boolean" == typeof r
              ? (o.animate = r)
          ...
          return (
            (o = i.callFilters("instructionParseFilterArgs", o, arguments)),
            n.freeze(o),
            o
          );
        },
        parseSortArgs: function (t) {
          ...
          return (
            s && (o.command = i.parseSortString(s, o.command)),
            (o = i.callFilters("instructionParseSortArgs", o, arguments)),
            n.freeze(o),
            o
          );
        },
        parseInsertArgs: function (t) {
          ...
          for (
            ...
            null !== (r = t[s]) &&
              ("number" == typeof r
                ? (o.command.index = r)
                : "string" == typeof r && ["before", "after"].indexOf(r) > -1
                ? (o.command.position = r)
                : "string" == typeof r
                ? (o.command.collection = n.arrayFromList(
                    n.createElement(r).childNodes
                  ))
                : "object" == typeof r && n.isElement(r, i.dom.document)
                ? o.command.collection.length
                  ? (o.command.sibling = r)
                  : (o.command.collection = [r])
                : "object" == typeof r && r.length
                ? o.command.collection.length
                  ? (o.command.sibling = r[0])
                  : (o.command.collection = r)
                : "object" == typeof r && r.childNodes && r.childNodes.length
                ? o.command.collection.length
                  ? (o.command.sibling = r.childNodes[0])
                  : (o.command.collection = n.arrayFromList(r.childNodes))
                : "object" == typeof r
                ? n.extend(o.command, r)
                : "boolean" == typeof r
                ? (o.animate = r)
          ...
          return (
            ...
            (o = i.callFilters("instructionParseInsertArgs", o, arguments)),
            n.freeze(o),
            o
          );
        },
        parseRemoveArgs: function (t) {
          ...
          for (
            ...
            if (null !== (s = t[a]))
              switch (typeof s) {
                ...
                case "string":
                  o.command.collection = n.arrayFromList(
                    i.dom.parent.querySelectorAll(s)
                  );
                  break;
                case "object":
                  s && s.length
                    ? (o.command.collection = s)
                    : n.isElement(s, i.dom.document)
                    ? (o.command.collection = [s])
                    : n.extend(o.command, s);
                  break;
                case "boolean":
                  o.animate = s;
                  break;
          ...
          if (o.command.collection.length)
            for (a = 0; (r = i.targets[a]); a++)
              o.command.collection.indexOf(r.dom.el) > -1 &&
                o.command.targets.push(r);
          return (
            !o.command.targets.length &&
              i.config.debug.showWarnings &&
                ...
                i.config.controls.enable &&
                  (i.isToggling
                    ? (i.buildToggleArray(t.instruction.command),
                      (r = i.getToggleSelector()),
                      i.updateControls({ filter: { selector: r } }))
        ...
        getDataOperation: function (t) {
          ...
          if (
            ...
            i.dom.targets.length && !(r = i.state.activeDataset || []).length)
          )
            throw new Error(e.messages.errorDatasetNotSet());
          return (
            (o.id = n.randomHex()),
            (o.startState = i.state),
            (o.startDataset = r),
            (o.newDataset = t.slice()),
            i.diffDatasets(o),
            (o.startOrder = i.targets),
            (o.newOrder = o.show),
            i.config.animation.enable &&
              (i.getStartMixData(o),
              i.setInter(o),
              (o.docState = n.getDocumentState(i.dom.document)),
              i.getInterMixData(o),
              i.setFinal(o),
              i.getFinalMixData(o),
              i.parseEffects(),
              (o.hasEffect = i.hasEffect()),
              i.getTweenData(o)),
            (i.targets = o.show.slice()),
            (o.newState = i.buildState(o)),
            Array.prototype.push.apply(i.targets, o.toRemove),
            i.callFilters("operationMappedGetDataOperation", o, arguments)
          );
        },
        diffDatasets: function (t) {
          var i = this,
            ...
            p = -1;
          for (
            i.callActions("beforeDiffDatasets", arguments), p = 0;
            (a = t.newDataset[p]);
            p++
          ) {
            if (
              void 0 === (f = a[i.config.data.uidKey]) ||
              f.toString().length < 1
            )
              throw new TypeError(
            ...
            if (d[f])
              throw new Error(e.messages.errorDatasetDuplicateUid({ uid: f }));
            (d[f] = !0),
              (l = i.cache[f]) instanceof e.Target
                ? (i.config.data.dirtyCheck &&
                    !n.deepEquals(a, l.data) &&
                    ((c = l.render(a)),
                    (l.data = a),
                    c !== l.dom.el &&
                      (l.isInDom &&
                        (l.unbindEvents(),
                        i.dom.parent.replaceChild(c, l.dom.el)),
                      l.isShown || (c.style.display = "none"),
                      (l.dom.el = c),
                      l.isInDom && l.bindEvents())),
                  (c = l.dom.el))
                : ((l = new e.Target()).init(null, i, a), l.hide()),
              l.isInDom
                ? ((h = l.dom.el.nextElementSibling),
                  r.push(f),
                  u &&
                    (u.lastElementChild &&
                      u.appendChild(i.dom.document.createTextNode(" ")),
                    i.insertDatasetFrag(u, l.dom.el, s),
                    (u = null)))
                : (u || (u = i.dom.document.createDocumentFragment()),
                  u.lastElementChild &&
                    u.appendChild(i.dom.document.createTextNode(" ")),
          ...
          for (
            u &&
              ((h = h || i.config.layout.siblingAfter) &&
                u.appendChild(i.dom.document.createTextNode(" ")),
              i.insertDatasetFrag(u, h, s)),
              p = 0;
            (a = t.startDataset[p]);
            p++
          )
            (f = a[i.config.data.uidKey]),
              (l = i.cache[f]),
              t.show.indexOf(l) < 0
                ? (t.hide.push(l), t.toHide.push(l), t.toRemove.push(l))
                : o.push(f);
          n.isEqualArray(o, r) || (t.willSort = !0),
            i.callActions("afterDiffDatasets", arguments);
        },
        insertDatasetFrag: function (t, e, i) {
          var o = this,
            r = e
              ? n.arrayFromList(o.dom.parent.children).indexOf(e)
              : o.targets.length;
        ...
        toggleOff: function () {
          ...
          return (
            ...
            t.multimix({ filter: o }, e.animate, e.callback)
          );
        },
        sort: function () {
          var t = this,
        ...
        dataset: function () {
          ...
          return (
            ...
            t.isBusy
              ? (((o = new e.QueueItem()).args = arguments),
                (o.instruction = n),
                t.queueMix(o))
              : (n.callback && (t.userCallback = n.callback),
                ...
                (i = t.getDataOperation(n.command.dataset)),
                t.goMix(r, i))
          );
        },
        multimix: function () {
        ...
        getOperation: function (t) {
          ...
          return (
            ...
            (c.command = t),
            (c.startState = i.state),
            (c.triggerElement = i.lastClicked),
            i.isBusy
              ? (i.config.debug.showWarnings &&
                  console.warn(e.messages.warningGetOperationInstanceBusy()),
                null)
              : (l && i.insertTargets(l, c),
                a && (c.toRemove = a.targets),
                (c.startSort = c.newSort = c.startState.activeSort),
                (c.startOrder = c.newOrder = i.targets),
                o &&
                  ((c.startSort = c.startState.activeSort),
                  (c.newSort = o),
                  (c.willSort = i.willSort(o, c.startState.activeSort)),
                  c.willSort && i.sortOperation(c)),
                (c.startFilter = c.startState.activeFilter),
                (c.newFilter =
                  r || n.extend(new e.CommandFilter(), c.startFilter)),
                "all" === c.newFilter.selector
                  ? (c.newFilter.selector = i.config.selectors.target)
                ...
                i.config.animation.enable &&
                  (i.getStartMixData(c),
                  i.setInter(c),
                  (c.docState = n.getDocumentState(i.dom.document)),
                  i.getInterMixData(c),
                  i.setFinal(c),
                  i.getFinalMixData(c),
                  i.parseEffects(),
                  (c.hasEffect = i.hasEffect()),
                  i.getTweenData(c)),
                c.willSort && (i.targets = c.newOrder),
                (c.newState = i.buildState(c)),
                i.callFilters("operationMappedGetOperation", c, arguments))
          );
        },
        tween: function (t, e) {
          var n = null,
            ...
            r = -1;
          for (
            e = Math.min(e, 1), e = Math.max(e, 0), r = 0;
            (n = t.show[r]);
            r++
          )
        ...
        getConfig: function (t) {
          var e = this,
            i = null;
          return (
            (i = t ? n.getProperty(e.config, t) : e.config),
            e.callFilters("valueGetConfig", i, arguments)
          );
        },
        ...
        getState: function () {
          ...
          return (
            ...
            n.extend(i, t.state),
            n.freeze(i),
            t.callFilters("stateGetState", i, arguments)
          );
        },
        ...
        destroy: function (t) {
          var n = this,
            ...
            r = 0;
          for (
            n.callActions("beforeDestroy", arguments), r = 0;
            (i = n.controls[r]);
            r++
          )
            i.removeBinding(n);
      ...
      n.extend(e.Target.prototype, {
        ...
        init: function (t, n, i) {
          ...
          if (
            ...
            i && n.config.data.uidKey)
          ) {
            if (
              void 0 === (r = i[n.config.data.uidKey]) ||
              r.toString().length < 1
            )
              throw new TypeError(
                e.messages.errorDatasetInvalidUidKey({
        ...
        render: function (t) {
          ...
          return (
            (a = o(t)) && "object" == typeof a && n.isElement(a)
              ? (r = a)
              : "string" == typeof a &&
        ...
        applyTween: function (t, n) {
          ...
          for (
            i.callActions("beforeApplyTween", arguments),
              l.x = s.x,
              l.y = s.y,
              0 === n ? i.hide() : i.isShown || i.show(),
              c = 0;
            (o = e.features.TWEENABLE[c]);
            c++
          )
          ...
          (l.x || l.y) && a.unshift("translate(" + l.x + "px, " + l.y + "px)"),
            a.length &&
              (i.dom.el.style[e.features.transformProp] = a.join(" ")),
        ...
        applyStylesIn: function (t) {
          ...
          n.callActions("beforeApplyStylesIn", arguments),
            ...
            n.mixer.config.animation.animateResizeTargets &&
              ("show" !== t.statusChange &&
                ((n.dom.el.style.width = i.width + "px"),
                (n.dom.el.style.height = i.height + "px")),
              (n.dom.el.style.marginRight = i.marginRight + "px"),
              (n.dom.el.style.marginBottom = i.marginBottom + "px")),
            o && (n.dom.el.style.opacity = i.opacity),
            "show" === t.statusChange && (r = r.concat(n.mixer.transformIn)),
            (n.dom.el.style[e.features.transformProp] = r.join(" ")),
        ...
        applyStylesOut: function (t) {
          ...
          switch (
            ...
            case "hide":
              s && (n.dom.el.style.opacity = n.mixer.effectsOut.opacity),
                (o = o.concat(n.mixer.transformOut));
              break;
            case "show":
        ...
        writeTransitionRule: function (t, e, n) {
          ...
          return (
            (r =
              ...
              o +
              "ms " +
              ("opacity" === t ? "linear" : i.mixer.config.animation.easing)),
        ...
        applyTransition: function (t) {
          ...
          n.callActions("beforeApplyTransition", arguments),
            (n.dom.el.style[e.features.transitionProp] = i),
        ...
        getPosData: function (n) {
          ...
          return (
            ...
            (i.mixer.config.animation.animateResizeTargets || n) &&
              ((r = i.dom.el.getBoundingClientRect()),
              (s.top = r.top),
              (s.right = r.right),
              (s.bottom = r.bottom),
              (s.left = r.left),
      ...
      n.extend(e.Collection.prototype, {
        ...
        mixitup: function (t) {
          var i = this,
            ...
            a = -1;
          for (
            this.callActions("beforeMixitup"), r.shift(), a = 0;
            (o = i[a]);
            a++
          )
      ...
      "object" == typeof exports && "object" == typeof module
        ...
        : (void 0 !== t.mixitup && "function" == typeof t.mixitup) ||
          (t.mixitup = e),
      ...
      n.extend(g.prototype, {
        ...
        updateCursor: function (t, e) {
          ...
          s &&
            ...
            i
              ...
              : s.opts.touch &&
                (s.opts.touch.vertical || r.group.length > 1) &&
                "video" !== s.contentType &&
            ...
            "zoom" === e
              ? ((s.isAnimating = !0),
                ...
                "auto" == (r = t.opts.zoomOpacity) &&
                  (r = Math.abs(t.width / t.height - c.width / c.height) > 0.1),
        ...
        cleanUp: function (e) {
          ...
          s.current.$slide.trigger("onReset"),
            ...
            s.current.opts.backFocus &&
              ((a && a.length && a.is(":visible")) || (a = s.$trigger),
              a &&
                a.length &&
                ((o = t.scrollX),
                (r = t.scrollY),
        ...
        updateControls: function () {
          ...
          i.$slide.trigger("refresh"),
            a && a.length
              ? ((t.$caption = s), s.children().eq(0).html(a))
              : (t.$caption = null),
            ...
            "image" === i.type
              ? r
                  ...
                  .show()
              : i.opts.toolbar &&
                r.find("[data-fancybox-download],[data-fancybox-zoom]").hide(),
          ...
          if ((l = f.match(i.matcher))) {
            if (
              ...
              for (var o = 0; o < u.length; ++o) {
                var s = u[o].split("=", 2);
                2 == s.length &&
                  (h[s[0]] = decodeURIComponent(s[1].replace(/\+/g, " ")));
              }
            }
            return (
    ...
    (u.prototype.destroy = function () {
      ...
      (u.prototype.limitMovement = function () {
        ...
        return (
          ...
          u > 0 && r > e && (r = e - 1 + Math.pow(-e + f + u, 0.8) || 0),
          u < 0 && r < i && (r = i + 1 - Math.pow(i - f - u, 0.8) || 0),
          { top: r, left: o }
        );
      }),
      (u.prototype.limitPosition = function (t, e, n, i) {
        ...
        return (
          ...
          i > r
            ? (e = (e = e > 0 ? 0 : e) < r - i ? r - i : e)
            : (e = Math.max(0, r / 2 - i / 2)),
          { top: e, left: t }
        );
      }),
  ...
  (function (t, e) {
    ...
    var t = function (e, n) {
        for (var i in n)
          n.hasOwnProperty(i) &&
            (e[i] = "object" == typeof n[i] ? t(e[i], n[i]) : n[i]);
        return e;
      },
      e = function (t, e) {
        var n,
          ...
          a = 0,
          l = function () {
            (a = r()), (s = null), (o = t.apply(n, i)), (n = i = null);
          };
        return function () {
          var c = r(),
            u = e - (c - a);
        ...
        _setScrollOffset: function () {
          "string" == typeof this.options.offset &&
            (this.scrollOffset = (function (t, e) {
              for (var n = 0, i = t.offsetHeight; t; )
                (n += t.offsetTop), (t = t.offsetParent);
              return "bottom" === e && (n += i), n;
            })(
  ...
  document.addEventListener("DOMContentLoaded", function () {
    $(".owl-carousel").owlCarousel({ items: 1, loop: !0, margin: 50 });
    new Headhesive(".header-nav-link", { offset: 1200 }),
      mixitup(".recent-sort-item");
    const t = document.querySelector(".recent-sort-button"),
      e = document.querySelectorAll(".recent-btn");
    t.addEventListener("click", ({ target: t }) => {
      e.forEach((t) => {
        t.classList.remove("recent-active");
      }),
        t.classList.contains("recent-btn") && t.classList.add("recent-active");
    });
    let n = new ProgressBar.Circle(".progress-blue", {
        color: "#a5d2da",
        trailColor: "#d7ebef",
        strokeWidth: 9,
        trailWidth: 9,
      ...
      i = new ProgressBar.Circle(".progress-green", {
        color: "#9bd6a7",
        trailColor: "#d4edd9",
        strokeWidth: 9,
        trailWidth: 9,
      ...
      o = new ProgressBar.Circle(".progress-orange", {
        color: "#fbbe67",
        trailColor: "#fde4bf",
        strokeWidth: 9,
        trailWidth: 9,
      ...
      r = new ProgressBar.Circle(".progress-blue-dark", {
        color: "#036b7e",
        trailColor: "#72acb7",
        strokeWidth: 9,
        trailWidth: 9,
    ...
    document
      .querySelector(".faq-accardion")
      .addEventListener("click", ({ target: t }) => {
        (t.classList.contains("faq-accardion-button") ||
          t.classList.contains("faq-accardion-subtitle")) &&
          ("+" == t.parentElement.lastElementChild.textContent
            ? ((t.parentElement.lastElementChild.innerHTML = "-"),
              t.parentElement.lastElementChild.classList.add("faq-btn-active"),
              (t.parentElement.nextElementSibling.style.display = "block"))
            : ((t.parentElement.lastElementChild.innerHTML = "+"),
              (t.parentElement.nextElementSibling.style.display = "none"),
              t.parentElement.lastElementChild.classList.remove(
                "faq-btn-active"
              )));
      }),
    ...
    const s = document.querySelector(".revent-btn"),
      a = document.querySelector(".recent-sort-item");
    s.addEventListener("click", () => {
      "show more" == s.textContent
        ? (document.body.clientWidth < 1144 && document.body.clientWidth > 770
            ? (a.style.maxHeight = "863px")
            : (document.body.clientWidth < 770 &&
                document.body.clientWidth > 437) ||
              (document.body.clientWidth < 437 &&
                document.body.clientWidth > 319)
            ? (a.style.maxHeight = "1740px")
            : (a.style.maxHeight = "560px"),
        ...
        : (document.body.clientWidth < 1144 && document.body.clientWidth > 770
            ...
            ? (a.style.maxHeight = "863px")
            : document.body.clientWidth < 400 && document.body.clientWidth > 319
            ? (a.style.maxHeight = "696px")
            : (a.style.maxHeight = "290px"),
    ...
    $(window).scroll(function () {
      if (c) return;
      let t = $(this);
      t.scrollTop() + t.height() + 50 < l.offset().top ||
        (n.animate(0.92, { duration: 1500 }),
        i.animate(0.86, { duration: 1500 }),
        o.animate(0.78, { duration: 1500 }),
        r.animate(0.75, { duration: 1500 }),
        (c = !0));
    });
    const u = document.querySelector(".mobile-nav__button"),
      h = document.querySelector(".mobile-nav-link");
    u.addEventListener("click", () => {
      u.classList.toggle("is-active"),
        u.classList.contains("is-active")
    ...
    const d = document.querySelectorAll(".input__blure"),
      f = document.querySelector(".form__submit"),
      p = document.querySelector(".modal__overlay"),
      g = document.querySelector(".modal__content");
    d.forEach((t) => {
      t.addEventListener("input", () => {
        t.value
          ? t.nextElementSibling.classList.add("contact__label-active")
          : t.nextElementSibling.classList.remove("contact__label-active");
      }),
