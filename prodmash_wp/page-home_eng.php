          ...
          <div class="header__inner">
            <div class="header__navigation">
              <div class="header__logo logo">
                ...
                WE KNOW TO CONQUER STEEL
                </p>
              </div>
              <nav class="header__menu">
              <?php
              wp_nav_menu( [
                'theme_location'  => 'menu_main_eng',
                'container'       => null, 
            ...
            <div class="header__main">
              ...
              <a href="products.html" class="header__main_more">More details</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="footer__outer">
        <div class="wrapper">
          <div class="footer__inner">
            <h3 class="orange__before_line">Contacts</h3>
